...
function addIndustry2() {
    ...
    if (!isMemberExsit("member_industry_" + industry_id + "_" + industryCountryId)) {
        var html = "<span id='member_industry_" + industry_id + "_" + industryCountryId + "' class='alert alert-info preference_selected preference_selected-width'>" +
                "<a href='###' data-dismiss='alert' class='glyphicon glyphicon-remove pull-right'></a>Local：" + industryCountryName + "<br/>Industry：" + industryName +
                "<br/>Amount：" + currencyName + " <a href='###'>" + transfer2Currency(rangeMin) + " - " + transfer2Currency(rangeMax) + "</a>&nbsp;" +
...
$(".glyphicon-remove").click(function() {
    var obj = $(this)
    custom_confirm("Are you sure you want to delete the preference?", "New Message", function() {
