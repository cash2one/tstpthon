...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Member.expired_date'
        db.delete_column(u'member_member', 'expired_date')

        # Adding field 'Member.expire_date'
        db.add_column(u'member_member', 'expire_date',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Member.expired_date'
        db.add_column(u'member_member', 'expired_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 8, 0, 0)),
                      keep_default=False)

        # Deleting field 'Member.expire_date'
        db.delete_column(u'member_member', 'expire_date')
