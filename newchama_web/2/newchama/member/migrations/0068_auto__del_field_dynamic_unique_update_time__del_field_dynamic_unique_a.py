...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('dynamic_unique', 'update_time')

        # Deleting field 'dynamic_unique.add_time'
        db.delete_column('dynamic_unique', 'add_time')


    def backwards(self, orm):
        # Adding field 'dynamic_unique.update_time'
        db.add_column('dynamic_unique', 'update_time',
        ...
        db.add_column('dynamic_unique', 'add_time',
