...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MemberInvestmentField.deal_size'
        db.delete_column(u'member_memberinvestmentfield', 'deal_size')

        # Adding field 'MemberInvestmentField.deal_category'
        db.add_column('member_memberinvestmentfield', 'deal_category',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


        # Changing field 'MemberInvestmentField.deal_type'
        db.alter_column('member_memberinvestmentfield', 'deal_type', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

    def backwards(self, orm):
        # Adding field 'MemberInvestmentField.deal_size'
        db.add_column(u'member_memberinvestmentfield', 'deal_size',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'MemberInvestmentField.deal_category'
        db.delete_column('member_memberinvestmentfield', 'deal_category')


        # Changing field 'MemberInvestmentField.deal_type'
        db.alter_column('member_memberinvestmentfield', 'deal_type', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 11, 0, 0)'}),
        ...
        u'member.memberdynamic': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 11, 0, 0)'})
        },
        ...
        u'member.memberinvestmentfield': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['area.Country']", 'null': 'True', 'blank': 'True'}),
            'deal_category': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'deal_currency': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'deal_size_max': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'deal_size_min': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'deal_type': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
            'ebita': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'growth': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'hot': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'member.preference': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
