...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuyerDealCategory.name_cn'
        db.add_column(u'member_buyerdealcategory', 'name_cn',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BuyerDealCategory.name_en'
        db.add_column(u'member_buyerdealcategory', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetailDealType.name_cn'
        db.add_column(u'member_detaildealtype', 'name_cn',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetailDealType.name_en'
        db.add_column(u'member_detaildealtype', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BuyerDealCategory.name_cn'
        db.delete_column(u'member_buyerdealcategory', 'name_cn')

        # Deleting field 'BuyerDealCategory.name_en'
        db.delete_column(u'member_buyerdealcategory', 'name_en')

        # Deleting field 'DetailDealType.name_cn'
        db.delete_column(u'member_detaildealtype', 'name_cn')

        # Deleting field 'DetailDealType.name_en'
        db.delete_column(u'member_detaildealtype', 'name_en')
