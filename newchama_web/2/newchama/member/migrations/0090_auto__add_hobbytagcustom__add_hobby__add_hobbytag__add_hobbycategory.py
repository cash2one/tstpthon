...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HobbyTagCustom'
        db.create_table('member_hobby_tag_custom', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hobby', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hobby_tag_custom', to=orm['member.Hobby'])),
            ('keyword', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'member', ['HobbyTagCustom'])

        # Adding model 'Hobby'
        db.create_table('member_hobby', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='member_hobby', to=orm['member.Member'])),
            ('deal_currency', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('deal_size_min', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True)),
            ('deal_size_max', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('edit_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 8, 14, 0, 0), auto_now=True, blank=True)),
            ('is_delete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'member', ['Hobby'])

        # Adding model 'HobbyTag'
        db.create_table('member_hobby_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hobby', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hobby_tag', to=orm['member.Hobby'])),
        ))
        db.send_create_signal(u'member', ['HobbyTag'])

        # Adding M2M table for field deal_category on 'HobbyTag'
        m2m_table_name = db.shorten_name('member_hobby_tag_deal_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('hobbytag', models.ForeignKey(orm[u'member.hobbytag'], null=False)),
            ('buyerdealcategory', models.ForeignKey(orm[u'member.buyerdealcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['hobbytag_id', 'buyerdealcategory_id'])

        # Adding model 'HobbyCategory'
        db.create_table('member_hobby_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hobby', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hobby_category', to=orm['member.Hobby'])),
        ))
        db.send_create_signal(u'member', ['HobbyCategory'])

        # Adding M2M table for field deal_category on 'HobbyCategory'
        m2m_table_name = db.shorten_name('member_hobby_category_deal_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('hobbycategory', models.ForeignKey(orm[u'member.hobbycategory'], null=False)),
            ('buyerdealcategory', models.ForeignKey(orm[u'member.buyerdealcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['hobbycategory_id', 'buyerdealcategory_id'])

        # Adding M2M table for field deal_type on 'HobbyCategory'
        m2m_table_name = db.shorten_name('member_hobby_category_deal_type')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('hobbycategory', models.ForeignKey(orm[u'member.hobbycategory'], null=False)),
            ('detaildealtype', models.ForeignKey(orm[u'member.detaildealtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['hobbycategory_id', 'detaildealtype_id'])


    def backwards(self, orm):
        # Deleting model 'HobbyTagCustom'
        db.delete_table('member_hobby_tag_custom')

        # Deleting model 'Hobby'
        db.delete_table('member_hobby')

        # Deleting model 'HobbyTag'
        db.delete_table('member_hobby_tag')

        # Removing M2M table for field deal_category on 'HobbyTag'
        db.delete_table(db.shorten_name('member_hobby_tag_deal_category'))

        # Deleting model 'HobbyCategory'
        db.delete_table('member_hobby_category')

        # Removing M2M table for field deal_category on 'HobbyCategory'
        db.delete_table(db.shorten_name('member_hobby_category_deal_category'))

        # Removing M2M table for field deal_type on 'HobbyCategory'
        db.delete_table(db.shorten_name('member_hobby_category_deal_type'))
    ...
    models = {
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.hobby': {
            ...
            'deal_size_max': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'deal_size_min': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'member.memberdynamic': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)'})
        },
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
