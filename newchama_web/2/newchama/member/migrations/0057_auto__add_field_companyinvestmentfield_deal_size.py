...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyInvestmentField.deal_size'
        db.add_column('member_companyinvestmentfield', 'deal_size',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyInvestmentField.deal_size'
        db.delete_column('member_companyinvestmentfield', 'deal_size')
