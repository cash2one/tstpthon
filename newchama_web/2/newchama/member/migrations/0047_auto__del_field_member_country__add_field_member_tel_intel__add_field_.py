...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'member_member', 'country_id')

        # Adding field 'Member.tel_intel'
        db.add_column('member_member', 'tel_intel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Member.mobile_intel'
        db.add_column('member_member', 'mobile_intel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'member_member', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.Country'], null=True),
                      keep_default=False)

        # Deleting field 'Member.tel_intel'
        db.delete_column('member_member', 'tel_intel')

        # Deleting field 'Member.mobile_intel'
        db.delete_column('member_member', 'mobile_intel')
    ...
    models = {
        ...
        u'area.country': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'international_code': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
