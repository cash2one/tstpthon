...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'member_company', 'status',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'member_company', 'status')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
