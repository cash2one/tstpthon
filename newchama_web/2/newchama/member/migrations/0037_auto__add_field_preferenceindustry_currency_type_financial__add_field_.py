...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreferenceIndustry.currency_type_financial'
        db.add_column('member_preference_industry', 'currency_type_financial',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'PreferenceIndustry.country'
        db.add_column('member_preference_industry', 'country',
    ...
    def backwards(self, orm):
        # Deleting field 'PreferenceIndustry.currency_type_financial'
        db.delete_column('member_preference_industry', 'currency_type_financial')

        # Deleting field 'PreferenceIndustry.country'
        db.delete_column('member_preference_industry', 'country_id')


        # Changing field 'Preference.add_time'
        db.alter_column('member_preference', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
