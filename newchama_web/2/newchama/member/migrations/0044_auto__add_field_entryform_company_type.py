...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryForm.company_type'
        db.add_column('member_entryform', 'company_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryForm.company_type'
        db.delete_column('member_entryform', 'company_type')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 4, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
