...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompanyInvestmentHistory'
        db.create_table('member_companyinvestmenthistory', (
        ...
        db.send_create_signal(u'member', ['CompanyInvestmentHistory'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CompanyInvestmentHistory'
        db.delete_table('member_companyinvestmenthistory')
