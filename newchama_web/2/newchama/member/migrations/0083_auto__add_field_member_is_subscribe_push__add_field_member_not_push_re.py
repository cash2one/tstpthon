...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.is_subscribe_push'
        db.add_column('member_member', 'is_subscribe_push',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Member.not_push_reason'
        db.add_column('member_member', 'not_push_reason',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.is_subscribe_push'
        db.delete_column('member_member', 'is_subscribe_push')

        # Deleting field 'Member.not_push_reason'
        db.delete_column('member_member', 'not_push_reason')
    ...
    models = {
        ...
        u'member.member': {
            ...
            'is_subscribe_push': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
