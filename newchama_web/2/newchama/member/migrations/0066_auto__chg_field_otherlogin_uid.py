...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OtherLogin.uid'
        db.alter_column('other_login', 'uid', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'OtherLogin.uid'
        db.alter_column('other_login', 'uid', self.gf('django.db.models.fields.DateField')(null=True))
