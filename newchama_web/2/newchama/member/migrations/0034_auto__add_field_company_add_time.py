...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.add_time'
        db.add_column('member_company', 'add_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.add_time'
        db.delete_column('member_company', 'add_time')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
