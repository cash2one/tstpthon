...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'OtherLogin'
        db.delete_table('other_login')

        # Adding model 'dynamic_unique'
        db.create_table('dynamic_unique', (
            ...
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 21, 0, 0), auto_now_add=True, blank=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 21, 0, 0))),
        ))
        db.send_create_signal(u'member', ['dynamic_unique'])

        # Deleting field 'Member.weixin'
        db.delete_column(u'member_member', 'weixin_id')

        # Deleting field 'Member.linkedin'
        db.delete_column(u'member_member', 'linkedin_id')

        # Deleting field 'Member.weibo'
        db.delete_column(u'member_member', 'weibo_id')


    def backwards(self, orm):
        # Adding model 'OtherLogin'
        db.create_table('other_login', (
            ('uid', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('expires_in', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('login_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'member', ['OtherLogin'])

        # Deleting model 'dynamic_unique'
        db.delete_table('dynamic_unique')

        # Adding field 'Member.weixin'
        db.add_column(u'member_member', 'weixin',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='weixin', null=True, to=orm['member.OtherLogin'], blank=True),
                      keep_default=False)

        # Adding field 'Member.linkedin'
        db.add_column(u'member_member', 'linkedin',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='linkedin', null=True, to=orm['member.OtherLogin'], blank=True),
                      keep_default=False)

        # Adding field 'Member.weibo'
        db.add_column(u'member_member', 'weibo',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='weibo', null=True, to=orm['member.OtherLogin'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 21, 0, 0)'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        u'member.companyinvestmentfield': {
            'Meta': {'object_name': 'CompanyInvestmentField'},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 21, 0, 0)'}),
        ...
        u'member.dynamic_unique': {
            'Meta': {'object_name': 'dynamic_unique', 'db_table': "'dynamic_unique'"},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 21, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 21, 0, 0)'})
        },
        u'member.entryform': {
        ...
        u'member.preference': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
