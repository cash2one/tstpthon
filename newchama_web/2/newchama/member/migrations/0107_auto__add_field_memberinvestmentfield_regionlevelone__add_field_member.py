...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberInvestmentField.regionlevelone'
        db.add_column('member_memberinvestmentfield', 'regionlevelone',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.RegionLevelOne'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MemberInvestmentField.regionleveltwo'
        db.add_column('member_memberinvestmentfield', 'regionleveltwo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.RegionLevelTwo'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MemberInvestmentField.regionlevelthree'
        db.add_column('member_memberinvestmentfield', 'regionlevelthree',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.RegionLevelThree'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberInvestmentField.regionlevelone'
        db.delete_column('member_memberinvestmentfield', 'regionlevelone_id')

        # Deleting field 'MemberInvestmentField.regionleveltwo'
        db.delete_column('member_memberinvestmentfield', 'regionleveltwo_id')

        # Deleting field 'MemberInvestmentField.regionlevelthree'
        db.delete_column('member_memberinvestmentfield', 'regionlevelthree_id')
    ...
    models = {
        ...
        u'log.emailtracking': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'lastchanged_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 10, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 10, 0, 0)'}),
        ...
        u'member.hobby': {
            ...
            'deal_size_max': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'deal_size_min': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 10, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'member.memberdynamic': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 10, 0, 0)'})
        },
