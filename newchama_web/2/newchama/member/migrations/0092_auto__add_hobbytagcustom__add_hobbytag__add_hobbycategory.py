...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('member_hobby_tag', (
            ...
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.Tag'])),
        ))
        ...
        db.create_table('member_hobby_category', (
            ...
            ('deal_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.BuyerDealCategory'])),
            ('sub_deal_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.DetailDealType'])),
        ))
    ...
    models = {
        ...
        u'member.hobbycategory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sub_deal_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['member.DetailDealType']"})
        },
        u'member.hobbytag': {
