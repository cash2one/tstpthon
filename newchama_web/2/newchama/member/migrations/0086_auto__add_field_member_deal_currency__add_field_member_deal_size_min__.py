...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.deal_currency'
        db.add_column('member_member', 'deal_currency',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Member.deal_size_min'
        db.add_column('member_member', 'deal_size_min',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Member.deal_size_max'
        db.add_column('member_member', 'deal_size_max',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Member.summary'
        db.add_column('member_member', 'summary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Member.investment'
        db.add_column('member_member', 'investment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.deal_currency'
        db.delete_column('member_member', 'deal_currency')

        # Deleting field 'Member.deal_size_min'
        db.delete_column('member_member', 'deal_size_min')

        # Deleting field 'Member.deal_size_max'
        db.delete_column('member_member', 'deal_size_max')

        # Deleting field 'Member.summary'
        db.delete_column('member_member', 'summary')

        # Deleting field 'Member.investment'
        db.delete_column('member_member', 'investment')
    ...
    models = {
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 3, 0, 0)'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.memberdynamic': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 3, 0, 0)'})
        },
        ...
        u'member.preference': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
