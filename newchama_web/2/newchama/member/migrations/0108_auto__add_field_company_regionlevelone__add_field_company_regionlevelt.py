...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.regionlevelone'
        db.add_column('member_company', 'regionlevelone',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.RegionLevelOne'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.regionleveltwo'
        db.add_column('member_company', 'regionleveltwo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.RegionLevelTwo'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.regionlevelthree'
        db.add_column('member_company', 'regionlevelthree',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.RegionLevelThree'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.regionlevelone'
        db.delete_column('member_company', 'regionlevelone_id')

        # Deleting field 'Company.regionleveltwo'
        db.delete_column('member_company', 'regionleveltwo_id')

        # Deleting field 'Company.regionlevelthree'
        db.delete_column('member_company', 'regionlevelthree_id')
