...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InviteCode.used_time'
        db.alter_column('member_invitecode', 'used_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'FindPasswordHistory.used_time'
        db.alter_column('member_findpasswordhistory', 'used_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'InviteCode.used_time'
        db.alter_column('member_invitecode', 'used_time', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'FindPasswordHistory.used_time'
        db.alter_column('member_findpasswordhistory', 'used_time', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
