...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'member_companyinvestmentfield', 'gross')

        # Adding field 'CompanyInvestmentField.growth'
        db.add_column('member_companyinvestmentfield', 'growth',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CompanyInvestmentField.hot'
        db.add_column('member_companyinvestmentfield', 'hot',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'member_companyinvestmentfield', 'gross',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'CompanyInvestmentField.growth'
        db.delete_column('member_companyinvestmentfield', 'growth')

        # Deleting field 'CompanyInvestmentField.hot'
        db.delete_column('member_companyinvestmentfield', 'hot')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 14, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
