...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CardMemberInvestmentField'
        db.create_table('member_cardmemberinvestmentfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.CardMember'])),
            ('tags', self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True)),
            ('revenue', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('growth', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('net_income', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('ebita', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('deal_size', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('hot', self.gf('django.db.models.fields.IntegerField')(default=5)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 6, 7, 0, 0))),
        ))
        db.send_create_signal(u'member', ['CardMemberInvestmentField'])

        # Adding model 'CardMember'
        db.create_table('member_cardmember', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('position_cn', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('position_en', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('tel_intel', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('tel', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('mobile_intel', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ...
            ('intro_cn', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('intro_en', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('weibo_url', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('qq', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('source_url', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('focus', self.gf('django.db.models.fields.CharField')(max_length=800, blank=True)),
        ))
        db.send_create_signal(u'member', ['CardMember'])


    def backwards(self, orm):
        # Deleting model 'CardMemberInvestmentField'
        db.delete_table('member_cardmemberinvestmentfield')

        # Deleting model 'CardMember'
        db.delete_table('member_cardmember')
    ...
    models = {
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 7, 0, 0)'}),
        ...
        u'member.cardmemberinvestmentfield': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 7, 0, 0)'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 7, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.memberdynamic': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 7, 0, 0)'})
        },
        ...
        u'member.preference': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 7, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
