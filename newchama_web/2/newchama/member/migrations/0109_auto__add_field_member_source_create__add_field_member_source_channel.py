...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.source_create'
        db.add_column('member_member', 'source_create',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Member.source_channel'
        db.add_column('member_member', 'source_channel',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.source_create'
        db.delete_column('member_member', 'source_create')

        # Deleting field 'Member.source_channel'
        db.delete_column('member_member', 'source_channel')
    ...
    models = {
        ...
        u'member.member': {
            ...
            'source_channel': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'source_create': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
