...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetailDealType.seller_category'
        db.add_column('member_detaildealtype', 'seller_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='deal_types', null=True, to=orm['member.SellerDealCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetailDealType.seller_category'
        db.delete_column('member_detaildealtype', 'seller_category_id')
    ...
    models = {
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 17, 0, 0)'}),
        ...
        u'member.hobby': {
            ...
            'deal_size_max': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'deal_size_min': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 17, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'member.memberdynamic': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 17, 0, 0)'})
        },
