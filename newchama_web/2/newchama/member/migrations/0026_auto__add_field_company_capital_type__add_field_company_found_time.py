...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.capital_type'
        db.add_column('member_company', 'capital_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Company.found_time'
        db.add_column('member_company', 'found_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.capital_type'
        db.delete_column('member_company', 'capital_type')

        # Deleting field 'Company.found_time'
        db.delete_column('member_company', 'found_time')
