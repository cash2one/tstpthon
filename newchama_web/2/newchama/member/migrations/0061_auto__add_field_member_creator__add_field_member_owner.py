...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.creator'
        db.add_column('member_member', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='creator', null=True, to=orm['adminuser.AdminUser']),
                      keep_default=False)

        # Adding field 'Member.owner'
        db.add_column('member_member', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owner', null=True, to=orm['adminuser.AdminUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.creator'
        db.delete_column('member_member', 'creator_id')

        # Deleting field 'Member.owner'
        db.delete_column('member_member', 'owner_id')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 2, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 2, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
