...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntryForm.password'
        db.alter_column('member_entryform', 'password', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Member.password'
        db.alter_column('member_member', 'password', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'EntryForm.password'
        db.alter_column('member_entryform', 'password', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Member.password'
        db.alter_column('member_member', 'password', self.gf('django.db.models.fields.CharField')(max_length=50))
