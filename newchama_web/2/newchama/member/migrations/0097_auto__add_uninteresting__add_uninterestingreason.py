...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Uninteresting'
        db.create_table(u'member_uninteresting', (
            ...
            ('created_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 8, 18, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'member', ['Uninteresting'])

        # Adding model 'UninterestingReason'
        db.create_table('member_uninteresting_reason', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uninteresting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.Uninteresting'])),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'member', ['UninterestingReason'])


    def backwards(self, orm):
        # Deleting model 'Uninteresting'
        db.delete_table(u'member_uninteresting')

        # Deleting model 'UninterestingReason'
        db.delete_table('member_uninteresting_reason')
    ...
    models = {
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 18, 0, 0)'}),
        ...
        u'member.detaildealtype': {
            ...
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'seller_category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'deal_types'", 'null': 'True', 'to': u"orm['member.SellerDealCategory']"})
        },
        u'member.entryform': {
        ...
        u'member.hobby': {
            ...
            'deal_size_max': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'deal_size_min': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'member.memberdynamic': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 18, 0, 0)'})
        },
        ...
        u'member.uninteresting': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 18, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['member.Member']"}),
