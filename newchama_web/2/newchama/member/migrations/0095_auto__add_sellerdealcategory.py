...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SellerDealCategory'
        db.create_table(u'member_sellerdealcategory', (
        ...
        db.send_create_signal(u'member', ['SellerDealCategory'])


    def backwards(self, orm):
        # Deleting model 'SellerDealCategory'
        db.delete_table(u'member_sellerdealcategory')
