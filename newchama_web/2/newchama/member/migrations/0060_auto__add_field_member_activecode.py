...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.activecode'
        db.add_column('member_member', 'activecode',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.activecode'
        db.delete_column('member_member', 'activecode')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 22, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 22, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
