...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PreferenceIndustry.range_min'
        db.alter_column('member_preference_industry', 'range_min', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

        # Changing field 'PreferenceIndustry.range_max'
        db.alter_column('member_preference_industry', 'range_max', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PreferenceIndustry.range_min'
        db.alter_column('member_preference_industry', 'range_min', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'PreferenceIndustry.range_max'
        db.alter_column('member_preference_industry', 'range_max', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 26, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
