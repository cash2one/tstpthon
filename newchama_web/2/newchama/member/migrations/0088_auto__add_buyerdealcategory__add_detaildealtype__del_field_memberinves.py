...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BuyerDealCategory'
        db.create_table(u'member_buyerdealcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'member', ['BuyerDealCategory'])

        # Adding model 'DetailDealType'
        db.create_table(u'member_detaildealtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deal_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.BuyerDealCategory'])),
        ))
        db.send_create_signal(u'member', ['DetailDealType'])

        # Deleting field 'MemberInvestmentField.deal_category'
        db.delete_column(u'member_memberinvestmentfield', 'deal_category')

        # Deleting field 'MemberInvestmentField.deal_type'
        db.delete_column(u'member_memberinvestmentfield', 'deal_type')

        # Adding M2M table for field deal_category on 'MemberInvestmentField'
        m2m_table_name = db.shorten_name('member_memberinvestmentfield_deal_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('memberinvestmentfield', models.ForeignKey(orm[u'member.memberinvestmentfield'], null=False)),
            ('buyerdealcategory', models.ForeignKey(orm[u'member.buyerdealcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['memberinvestmentfield_id', 'buyerdealcategory_id'])

        # Adding M2M table for field deal_type on 'MemberInvestmentField'
        m2m_table_name = db.shorten_name('member_memberinvestmentfield_deal_type')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('memberinvestmentfield', models.ForeignKey(orm[u'member.memberinvestmentfield'], null=False)),
            ('detaildealtype', models.ForeignKey(orm[u'member.detaildealtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['memberinvestmentfield_id', 'detaildealtype_id'])


    def backwards(self, orm):
        # Deleting model 'BuyerDealCategory'
        db.delete_table(u'member_buyerdealcategory')

        # Deleting model 'DetailDealType'
        db.delete_table(u'member_detaildealtype')

        # Adding field 'MemberInvestmentField.deal_category'
        db.add_column(u'member_memberinvestmentfield', 'deal_category',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MemberInvestmentField.deal_type'
        db.add_column(u'member_memberinvestmentfield', 'deal_type',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field deal_category on 'MemberInvestmentField'
        db.delete_table(db.shorten_name('member_memberinvestmentfield_deal_category'))

        # Removing M2M table for field deal_type on 'MemberInvestmentField'
        db.delete_table(db.shorten_name('member_memberinvestmentfield_deal_type'))
    ...
    models = {
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 12, 0, 0)'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.detaildealtype': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['member.BuyerDealCategory']"}),
            'deal_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'member.entryform': {
        ...
        u'member.memberdynamic': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 12, 0, 0)'})
        },
        ...
        u'member.preference': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
