...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'member_company', 'stock_exchange_code')


    def backwards(self, orm):
        # Adding field 'Company.stock_exchange'
        db.add_column(u'member_company', 'stock_exchange',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.StockExchange'], null=True, db_column='stock_exchange_code', blank=True),
                      keep_default=False)
