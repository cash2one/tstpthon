...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MobileValidCode'
        db.create_table('mobile_validcode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mobile', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('valid_code', self.gf('django.db.models.fields.CharField')(max_length=6, blank=True)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'member', ['MobileValidCode'])


        # Changing field 'InviteCode.add_time'
        db.alter_column('member_invitecode', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Company.add_time'
        db.alter_column('member_company', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'EntryForm.add_time'
        db.alter_column('member_entryform', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'CVSourceContact.add_time'
        db.alter_column('cvsource_contact', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Member.add_time'
        db.alter_column('member_member', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'FindPasswordHistory.add_time'
        db.alter_column('member_findpasswordhistory', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Preference.add_time'
        db.alter_column('member_preference', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'MobileValidCode'
        db.delete_table('mobile_validcode')


        # Changing field 'InviteCode.add_time'
        db.alter_column('member_invitecode', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Company.add_time'
        db.alter_column('member_company', 'add_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'EntryForm.add_time'
        db.alter_column('member_entryform', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'CVSourceContact.add_time'
        db.alter_column('cvsource_contact', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Member.add_time'
        db.alter_column('member_member', 'add_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'FindPasswordHistory.add_time'
        db.alter_column('member_findpasswordhistory', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Preference.add_time'
        db.alter_column('member_preference', 'add_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'member.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 6, 0, 0)'}),
        ...
        u'member.companyinvestmentfield': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 6, 0, 0)'}),
        ...
        u'member.preference': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
