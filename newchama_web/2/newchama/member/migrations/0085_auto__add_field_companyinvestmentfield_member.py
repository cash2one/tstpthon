...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyInvestmentField.member'
        db.add_column('member_companyinvestmentfield', 'member',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='member_companyinvestfield', null=True, to=orm['member.Member']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyInvestmentField.member'
        db.delete_column('member_companyinvestmentfield', 'member_id')
