...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberInvestmentField.is_user'
        db.add_column('member_memberinvestmentfield', 'is_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberInvestmentField.is_user'
        db.delete_column('member_memberinvestmentfield', 'is_user')
