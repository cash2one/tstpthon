...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompanyStockSymbol'
        db.create_table('member_company_symbol', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invest_symbol', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.Company'])),
        ...
        db.send_create_signal(u'member', ['CompanyStockSymbol'])

        # Deleting field 'CompanyInvestmentHistory.type'
        db.delete_column(u'member_companyinvestmenthistory', 'type')

        # Adding field 'CompanyInvestmentHistory.title_cn'
        db.add_column('member_companyinvestmenthistory', 'title_cn',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.title_en'
        db.add_column('member_companyinvestmenthistory', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.invest_type'
        db.add_column('member_companyinvestmenthistory', 'invest_type',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.invest_stage'
        db.add_column('member_companyinvestmenthistory', 'invest_stage',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
        ...
        db.delete_column(u'member_company', 'stock_symbol_no_pre')

        # Deleting field 'Company.stock_symbol'
        db.delete_column(u'member_company', 'stock_symbol')


    def backwards(self, orm):
        # Deleting model 'CompanyStockSymbol'
        db.delete_table('member_company_symbol')

        # Adding field 'CompanyInvestmentHistory.type'
        db.add_column(u'member_companyinvestmenthistory', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CompanyInvestmentHistory.title_cn'
        db.delete_column('member_companyinvestmenthistory', 'title_cn')

        # Deleting field 'CompanyInvestmentHistory.title_en'
        db.delete_column('member_companyinvestmenthistory', 'title_en')

        # Deleting field 'CompanyInvestmentHistory.invest_type'
        db.delete_column('member_companyinvestmenthistory', 'invest_type')

        # Deleting field 'CompanyInvestmentHistory.invest_stage'
        db.delete_column('member_companyinvestmenthistory', 'invest_stage')


        # User chose to not deal with backwards NULL issues for 'CompanyInvestmentHistory.happen_date'
        raise RuntimeError("Cannot reverse this migration. 'CompanyInvestmentHistory.happen_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CompanyInvestmentHistory.happen_date'
        db.alter_column('member_companyinvestmenthistory', 'happen_date', self.gf('django.db.models.fields.DateTimeField')())
        ...
        db.add_column(u'member_company', 'stock_symbol_no_pre',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.stock_symbol'
        db.add_column(u'member_company', 'stock_symbol',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.companystocksymbol': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invest_symbol': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['member.Company']"}),
