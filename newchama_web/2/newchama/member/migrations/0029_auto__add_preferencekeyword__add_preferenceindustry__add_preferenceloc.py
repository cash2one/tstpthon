...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreferenceKeyword'
        db.create_table('member_preference_keyword', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('preference', self.gf('django.db.models.fields.related.ForeignKey')(related_name='preference_keyword', to=orm['member.Preference'])),
            ('keyword', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'member', ['PreferenceKeyword'])
        ...
        # Adding model 'PreferenceLocation'
        db.create_table('member_preference_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('preference', self.gf('django.db.models.fields.related.ForeignKey')(related_name='preference_location', to=orm['member.Preference'])),
        ...
        db.send_create_signal(u'member', ['PreferenceLocation'])

        # Adding model 'Preference'
        db.create_table('member_preference', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='member_preference', to=orm['member.Member'])),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ...
        db.send_create_signal(u'member', ['Preference'])


    def backwards(self, orm):
        # Deleting model 'PreferenceKeyword'
        db.delete_table('member_preference_keyword')

        # Deleting model 'PreferenceIndustry'
        db.delete_table('member_preference_industry')

        # Deleting model 'PreferenceLocation'
        db.delete_table('member_preference_location')

        # Deleting model 'Preference'
        db.delete_table('member_preference')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 31, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
