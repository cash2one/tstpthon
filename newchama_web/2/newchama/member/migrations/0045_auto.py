...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field focus_aspect on 'Member'
        m2m_table_name = db.shorten_name('member_member_focus_aspect')
        ...
        db.create_unique(m2m_table_name, ['member_id', 'industry_id'])


    def backwards(self, orm):
        # Removing M2M table for field focus_aspect on 'Member'
        db.delete_table(db.shorten_name('member_member_focus_aspect'))
