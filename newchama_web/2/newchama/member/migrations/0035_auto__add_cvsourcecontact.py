...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CVSourceContact'
        db.create_table('cvsource_contact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
            ('contact_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
            ('contact_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
            ('contact_tel', self.gf('django.db.models.fields.CharField')(default='', max_length=25, null=True)),
            ('contact_email', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
            ('contact_desc', self.gf('django.db.models.fields.TextField')(null=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contactor', to=orm['member.Member'])),
        ...
        db.send_create_signal(u'member', ['CVSourceContact'])


    def backwards(self, orm):
        # Deleting model 'CVSourceContact'
        db.delete_table('cvsource_contact')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 17, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 17, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
