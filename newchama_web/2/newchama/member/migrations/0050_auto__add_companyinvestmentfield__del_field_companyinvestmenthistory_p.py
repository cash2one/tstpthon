...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompanyInvestmentField'
        db.create_table('member_companyinvestmentfield', (
            ...
            ('deal_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('deal_currency', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 1, 4, 0, 0))),
        ))
        db.send_create_signal(u'member', ['CompanyInvestmentField'])

        # Deleting field 'CompanyInvestmentHistory.person'
        db.delete_column(u'member_companyinvestmenthistory', 'person')

        # Deleting field 'CompanyInvestmentHistory.targetcompany'
        db.delete_column(u'member_companyinvestmenthistory', 'targetcompany')

        # Deleting field 'CompanyInvestmentHistory.content'
        db.delete_column(u'member_companyinvestmenthistory', 'content')

        # Adding field 'CompanyInvestmentHistory.content_cn'
        db.add_column('member_companyinvestmenthistory', 'content_cn',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.content_en'
        db.add_column('member_companyinvestmenthistory', 'content_en',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.targetcompany_cn'
        db.add_column('member_companyinvestmenthistory', 'targetcompany_cn',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.targetcompany_en'
        db.add_column('member_companyinvestmenthistory', 'targetcompany_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.person_cn'
        db.add_column('member_companyinvestmenthistory', 'person_cn',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.person_en'
        db.add_column('member_companyinvestmenthistory', 'person_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.parent_company'
        db.add_column('member_company', 'parent_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.Company'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.data_source'
        db.add_column('member_company', 'data_source',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CompanyInvestmentField'
        db.delete_table('member_companyinvestmentfield')

        # Adding field 'CompanyInvestmentHistory.person'
        db.add_column(u'member_companyinvestmenthistory', 'person',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.targetcompany'
        db.add_column(u'member_companyinvestmenthistory', 'targetcompany',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.content'
        db.add_column(u'member_companyinvestmenthistory', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CompanyInvestmentHistory.content_cn'
        db.delete_column('member_companyinvestmenthistory', 'content_cn')

        # Deleting field 'CompanyInvestmentHistory.content_en'
        db.delete_column('member_companyinvestmenthistory', 'content_en')

        # Deleting field 'CompanyInvestmentHistory.targetcompany_cn'
        db.delete_column('member_companyinvestmenthistory', 'targetcompany_cn')

        # Deleting field 'CompanyInvestmentHistory.targetcompany_en'
        db.delete_column('member_companyinvestmenthistory', 'targetcompany_en')

        # Deleting field 'CompanyInvestmentHistory.person_cn'
        db.delete_column('member_companyinvestmenthistory', 'person_cn')

        # Deleting field 'CompanyInvestmentHistory.person_en'
        db.delete_column('member_companyinvestmenthistory', 'person_en')

        # Deleting field 'Company.parent_company'
        db.delete_column('member_company', 'parent_company_id')

        # Deleting field 'Company.data_source'
        db.delete_column('member_company', 'data_source')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 4, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
