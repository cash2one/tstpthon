...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntryForm.industry'
        db.alter_column('member_entryform', 'industry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['industry.Industry'], null=True))

        # Changing field 'EntryForm.country'
        db.alter_column('member_entryform', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.Country'], null=True))

        # Changing field 'EntryForm.fullname'
        db.alter_column('member_entryform', 'fullname', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'EntryForm.industry'
        db.alter_column('member_entryform', 'industry_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['industry.Industry']))

        # Changing field 'EntryForm.country'
        db.alter_column('member_entryform', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['area.Country']))

        # Changing field 'EntryForm.fullname'
        db.alter_column('member_entryform', 'fullname', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 14, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
