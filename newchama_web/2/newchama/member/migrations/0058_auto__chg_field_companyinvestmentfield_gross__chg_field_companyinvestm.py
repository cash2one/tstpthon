...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyInvestmentField.gross'
        db.alter_column('member_companyinvestmentfield', 'gross', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CompanyInvestmentField.deal_currency'
        db.alter_column('member_companyinvestmentfield', 'deal_currency', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CompanyInvestmentField.revenue'
        db.alter_column('member_companyinvestmentfield', 'revenue', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CompanyInvestmentField.ebita'
        db.alter_column('member_companyinvestmentfield', 'ebita', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CompanyInvestmentField.deal_type'
        db.alter_column('member_companyinvestmentfield', 'deal_type', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CompanyInvestmentField.deal_size'
        db.alter_column('member_companyinvestmentfield', 'deal_size', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CompanyInvestmentField.net_income'
        db.alter_column('member_companyinvestmentfield', 'net_income', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'CompanyInvestmentField.gross'
        db.alter_column('member_companyinvestmentfield', 'gross', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CompanyInvestmentField.deal_currency'
        db.alter_column('member_companyinvestmentfield', 'deal_currency', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CompanyInvestmentField.revenue'
        db.alter_column('member_companyinvestmentfield', 'revenue', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CompanyInvestmentField.ebita'
        db.alter_column('member_companyinvestmentfield', 'ebita', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CompanyInvestmentField.deal_type'
        db.alter_column('member_companyinvestmentfield', 'deal_type', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CompanyInvestmentField.deal_size'
        db.alter_column('member_companyinvestmentfield', 'deal_size', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CompanyInvestmentField.net_income'
        db.alter_column('member_companyinvestmentfield', 'net_income', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 11, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.companyinvestmentfield': {
            ...
            'gross': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
