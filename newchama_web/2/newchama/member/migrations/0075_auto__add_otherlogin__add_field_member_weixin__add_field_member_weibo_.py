...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('member_member', 'weixin',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='weixin', null=True, to=orm['member.OtherLogin']),
                      keep_default=False)

        # Adding field 'Member.weibo'
        db.add_column('member_member', 'weibo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='weibo', null=True, to=orm['member.OtherLogin']),
                      keep_default=False)

        # Adding field 'Member.linkedin'
        db.add_column('member_member', 'linkedin',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='linkedin', null=True, to=orm['member.OtherLogin']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('member_member', 'weixin_id')

        # Deleting field 'Member.weibo'
        db.delete_column('member_member', 'weibo_id')

        # Deleting field 'Member.linkedin'
        db.delete_column('member_member', 'linkedin_id')
