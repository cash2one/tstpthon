...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyInvestmentHistory.country'
        db.add_column('member_companyinvestmenthistory', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.Country'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.province'
        db.add_column('member_companyinvestmenthistory', 'province',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.Province'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.city'
        db.add_column('member_companyinvestmenthistory', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.City'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.industry'
        db.add_column('member_companyinvestmenthistory', 'industry',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['industry.Industry'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.targetcompany'
        db.add_column('member_companyinvestmenthistory', 'targetcompany',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.cv1'
        db.add_column('member_companyinvestmenthistory', 'cv1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.cv2'
        db.add_column('member_companyinvestmenthistory', 'cv2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.cv3'
        db.add_column('member_companyinvestmenthistory', 'cv3',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.amount'
        db.add_column('member_companyinvestmenthistory', 'amount',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.currency'
        db.add_column('member_companyinvestmenthistory', 'currency',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.person'
        db.add_column('member_companyinvestmenthistory', 'person',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyInvestmentHistory.usd'
        db.add_column('member_companyinvestmenthistory', 'usd',
                      self.gf('django.db.models.fields.IntegerField')(max_length=20, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CompanyInvestmentHistory.content'
        db.alter_column('member_companyinvestmenthistory', 'content', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CompanyInvestmentHistory.happen_date'
        db.alter_column('member_companyinvestmenthistory', 'happen_date', self.gf('django.db.models.fields.DateTimeField')(default=None))

    def backwards(self, orm):
        # Deleting field 'CompanyInvestmentHistory.country'
        db.delete_column('member_companyinvestmenthistory', 'country_id')

        # Deleting field 'CompanyInvestmentHistory.province'
        db.delete_column('member_companyinvestmenthistory', 'province_id')

        # Deleting field 'CompanyInvestmentHistory.city'
        db.delete_column('member_companyinvestmenthistory', 'city_id')

        # Deleting field 'CompanyInvestmentHistory.industry'
        db.delete_column('member_companyinvestmenthistory', 'industry_id')

        # Deleting field 'CompanyInvestmentHistory.targetcompany'
        db.delete_column('member_companyinvestmenthistory', 'targetcompany')

        # Deleting field 'CompanyInvestmentHistory.cv1'
        db.delete_column('member_companyinvestmenthistory', 'cv1')

        # Deleting field 'CompanyInvestmentHistory.cv2'
        db.delete_column('member_companyinvestmenthistory', 'cv2')

        # Deleting field 'CompanyInvestmentHistory.cv3'
        db.delete_column('member_companyinvestmenthistory', 'cv3')

        # Deleting field 'CompanyInvestmentHistory.amount'
        db.delete_column('member_companyinvestmenthistory', 'amount')

        # Deleting field 'CompanyInvestmentHistory.currency'
        db.delete_column('member_companyinvestmenthistory', 'currency')

        # Deleting field 'CompanyInvestmentHistory.person'
        db.delete_column('member_companyinvestmenthistory', 'person')

        # Deleting field 'CompanyInvestmentHistory.usd'
        db.delete_column('member_companyinvestmenthistory', 'usd')


        # Changing field 'CompanyInvestmentHistory.content'
        db.alter_column('member_companyinvestmenthistory', 'content', self.gf('django.db.models.fields.TextField')(default=None))

        # Changing field 'CompanyInvestmentHistory.happen_date'
        db.alter_column('member_companyinvestmenthistory', 'happen_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 30, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        u'member.companyinvestmenthistory': {
            'Meta': {'object_name': 'CompanyInvestmentHistory', 'db_table': "'member_companyinvestmenthistory'"},
