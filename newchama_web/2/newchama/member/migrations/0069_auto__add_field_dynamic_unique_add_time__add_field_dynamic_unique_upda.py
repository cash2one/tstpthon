...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'dynamic_unique.add_time'
        db.add_column('member_dynamic_unique', 'add_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 21, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'dynamic_unique.update_time'
        db.add_column('member_dynamic_unique', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 21, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'dynamic_unique.add_time'
        db.delete_column('member_dynamic_unique', 'add_time')

        # Deleting field 'dynamic_unique.update_time'
        db.delete_column('member_dynamic_unique', 'update_time')
    ...
    models = {
        ...
        u'member.dynamic_unique': {
            'Meta': {'object_name': 'dynamic_unique'},
