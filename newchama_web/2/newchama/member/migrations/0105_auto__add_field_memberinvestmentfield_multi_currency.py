...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberInvestmentField.multi_currency'
        db.add_column('member_memberinvestmentfield', 'multi_currency',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberInvestmentField.multi_currency'
        db.delete_column('member_memberinvestmentfield', 'multi_currency')
