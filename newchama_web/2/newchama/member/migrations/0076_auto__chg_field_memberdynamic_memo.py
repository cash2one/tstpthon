...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MemberDynamic.memo'
        db.alter_column('member_dynamic', 'memo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'MemberDynamic.memo'
        db.alter_column('member_dynamic', 'memo', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
