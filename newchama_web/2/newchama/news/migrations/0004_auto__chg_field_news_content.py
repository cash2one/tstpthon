...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'News.content'
        db.alter_column('cvsource_news', 'content', self.gf('django.db.models.fields.CharField')(max_length=4000, null=True))
    ...
    models = {
        u'news.news': {
            ...
            'content': ('django.db.models.fields.CharField', [], {'max_length': '8000', 'null': 'True', 'blank': 'True'}),
