...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Demand.other_companies'
        db.delete_column(u'demand_demand', 'other_companies')

        # Adding field 'Demand.other_target_companies'
        db.add_column('demand_demand', 'other_target_companies',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Demand.other_companies'
        db.add_column(u'demand_demand', 'other_companies',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Deleting field 'Demand.other_target_companies'
        db.delete_column('demand_demand', 'other_target_companies')
