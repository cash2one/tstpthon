...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemandCheckLog'
        db.create_table('demand_check_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('adminuser', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_check_log_adminuser', to=orm['adminuser.AdminUser'])),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_check_log_demand', to=orm['demand.Demand'])),
        ...
        db.send_create_signal(u'demand', ['DemandCheckLog'])


    def backwards(self, orm):
        # Deleting model 'DemandCheckLog'
        db.delete_table('demand_check_log')
