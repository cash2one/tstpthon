...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Demand.company_industry'
        db.delete_column(u'demand_demand', 'company_industry_id')

        # Adding M2M table for field company_industries on 'Demand'
        m2m_table_name = db.shorten_name(u'demand_demand_company_industries')
    ...
    def backwards(self, orm):
        # Adding field 'Demand.company_industry'
        db.add_column(u'demand_demand', 'company_industry',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_target_company_industry', null=True, to=orm['industry.Industry'], blank=True),
                      keep_default=False)

        # Removing M2M table for field company_industries on 'Demand'
        db.delete_table(db.shorten_name(u'demand_demand_company_industries'))
