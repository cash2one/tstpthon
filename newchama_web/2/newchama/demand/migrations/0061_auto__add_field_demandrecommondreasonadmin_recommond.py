...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DemandRecommondReasonAdmin.recommond'
        db.add_column('demand_admin_recommond_reason', 'recommond',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DemandRecommondReasonAdmin.recommond'
        db.delete_column('demand_admin_recommond_reason', 'recommond')
