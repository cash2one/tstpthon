...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemandRecommendLog'
        db.create_table('demand_recommend_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_recommend_log_demand', to=orm['demand.Demand'])),
        ...
        db.send_create_signal(u'demand', ['DemandRecommendLog'])


    def backwards(self, orm):
        # Deleting model 'DemandRecommendLog'
        db.delete_table('demand_recommend_log')
