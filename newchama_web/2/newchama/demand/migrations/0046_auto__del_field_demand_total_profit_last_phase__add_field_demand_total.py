...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'demand_demand', 'total_profit_last_phase')

        # Adding field 'Demand.total_assets'
        db.add_column('demand_demand', 'total_assets',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Demand.total_profit'
        db.add_column('demand_demand', 'total_profit',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'demand_demand', 'total_profit_last_phase',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'Demand.total_assets'
        db.delete_column('demand_demand', 'total_assets')

        # Deleting field 'Demand.total_profit'
        db.delete_column('demand_demand', 'total_profit')
