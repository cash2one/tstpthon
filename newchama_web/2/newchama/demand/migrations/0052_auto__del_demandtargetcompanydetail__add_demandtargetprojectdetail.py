...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DemandTargetProjectDetail'
        db.create_table('demand_target_project_detail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_detail', to=orm['demand.Demand'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_detail_project', to=orm['project.Project'])),
            ...
            ('update_member', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='demand_detail_update_member', null=True, to=orm['member.Member'])),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'demand', ['DemandTargetProjectDetail'])
    ...
    def backwards(self, orm):
        ...
        db.create_table('demand_target_company_detail', (
            ...
            ('recommend_type', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_detail', to=orm['demand.Demand'])),
            ('update_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_detail_update_member', null=True, to=orm['member.Member'], blank=True)),
            ('is_delete', self.gf('django.db.models.fields.BooleanField')(default=False)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        ...
        # Deleting model 'DemandTargetProjectDetail'
        db.delete_table('demand_target_project_detail')
