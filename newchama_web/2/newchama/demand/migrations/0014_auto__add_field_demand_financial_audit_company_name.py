...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demand.financial_audit_company_name'
        db.add_column('demand_demand', 'financial_audit_company_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demand.financial_audit_company_name'
        db.delete_column('demand_demand', 'financial_audit_company_name')
