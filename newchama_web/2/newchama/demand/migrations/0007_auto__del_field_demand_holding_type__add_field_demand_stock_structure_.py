...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Demand.holding_type'
        db.delete_column(u'demand_demand', 'holding_type')

        # Adding field 'Demand.stock_structure_percentage_type_management'
        db.add_column(u'demand_demand', 'stock_structure_percentage_type_management',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Demand.stock_structure_percentage_type_institutional'
        db.add_column(u'demand_demand', 'stock_structure_percentage_type_institutional',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Demand.holding_type'
        db.add_column(u'demand_demand', 'holding_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Demand.stock_structure_percentage_type_management'
        db.delete_column(u'demand_demand', 'stock_structure_percentage_type_management')

        # Deleting field 'Demand.stock_structure_percentage_type_institutional'
        db.delete_column(u'demand_demand', 'stock_structure_percentage_type_institutional')
