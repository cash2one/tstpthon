...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demand.process'
        db.add_column('demand_demand', 'process',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Demand.integrity'
        db.add_column('demand_demand', 'integrity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demand.process'
        db.delete_column('demand_demand', 'process')

        # Deleting field 'Demand.integrity'
        db.delete_column('demand_demand', 'integrity')
