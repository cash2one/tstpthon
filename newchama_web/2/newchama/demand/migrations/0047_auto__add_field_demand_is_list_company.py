...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demand.is_list_company'
        db.add_column('demand_demand', 'is_list_company',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demand.is_list_company'
        db.delete_column('demand_demand', 'is_list_company')
