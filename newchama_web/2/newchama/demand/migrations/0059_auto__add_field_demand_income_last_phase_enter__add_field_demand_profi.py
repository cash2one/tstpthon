...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demand.income_last_phase_enter'
        db.add_column('demand_demand', 'income_last_phase_enter',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Demand.profit_last_phase_enter'
        db.add_column('demand_demand', 'profit_last_phase_enter',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demand.income_last_phase_enter'
        db.delete_column('demand_demand', 'income_last_phase_enter')

        # Deleting field 'Demand.profit_last_phase_enter'
        db.delete_column('demand_demand', 'profit_last_phase_enter')
