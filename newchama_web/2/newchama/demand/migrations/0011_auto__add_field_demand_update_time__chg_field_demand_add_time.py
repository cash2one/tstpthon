...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demand.update_time'
        db.add_column('demand_demand', 'update_time',
    ...
    def backwards(self, orm):
        # Deleting field 'Demand.update_time'
        db.delete_column('demand_demand', 'update_time')


        # Changing field 'Demand.add_time'
        db.alter_column('demand_demand', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
