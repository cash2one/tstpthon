...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemandOtherTargetCompany'
        db.create_table('demand_other_target_company', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_other_company', to=orm['demand.Demand'])),
        ...
        db.send_create_signal(u'demand', ['DemandOtherTargetCompany'])

        # Deleting field 'Demand.other_target_companies'
        db.delete_column(u'demand_demand', 'other_target_companies')


    def backwards(self, orm):
        # Deleting model 'DemandOtherTargetCompany'
        db.delete_table('demand_other_target_company')

        # Adding field 'Demand.other_target_companies'
        db.add_column(u'demand_demand', 'other_target_companies',
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'expected_enterprice_value': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
