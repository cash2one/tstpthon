...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('demand_view_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_view_log_member', to=orm['member.Member'])),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_view_log_demand', to=orm['demand.Demand'])),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'demand', ['DemandViewLog'])


    def backwards(self, orm):
        # Deleting model 'DemandViewLog'
        db.delete_table('demand_view_log')
