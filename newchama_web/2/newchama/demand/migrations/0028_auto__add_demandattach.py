...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('demand_demandAttach', (
            ...
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_attach', to=orm['demand.Demand'])),
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_project_cn': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            ...
            'target_companies': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'demand_target_companies'", 'symmetrical': 'False', 'to': u"orm['member.Company']"}),
