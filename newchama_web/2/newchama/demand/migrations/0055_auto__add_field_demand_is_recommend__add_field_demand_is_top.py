...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demand.is_recommend'
        db.add_column('demand_demand', 'is_recommend',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Demand.is_top'
        db.add_column('demand_demand', 'is_top',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demand.is_recommend'
        db.delete_column('demand_demand', 'is_recommend')

        # Deleting field 'Demand.is_top'
        db.delete_column('demand_demand', 'is_top')
