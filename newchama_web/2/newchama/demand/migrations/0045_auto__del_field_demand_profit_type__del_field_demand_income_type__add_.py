...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'demand_demand', 'profit_type')

        # Deleting field 'Demand.income_type'
        db.delete_column(u'demand_demand', 'income_type')

        # Adding field 'Demand.income_enter'
        db.add_column('demand_demand', 'income_enter',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Demand.profit_enter'
        db.add_column('demand_demand', 'profit_enter',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'demand_demand', 'profit_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Demand.income_type'
        db.add_column(u'demand_demand', 'income_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Demand.income_enter'
        db.delete_column('demand_demand', 'income_enter')

        # Deleting field 'Demand.profit_enter'
        db.delete_column('demand_demand', 'profit_enter')
