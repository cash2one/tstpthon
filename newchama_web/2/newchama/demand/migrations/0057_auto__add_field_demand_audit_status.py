...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demand.audit_status'
        db.add_column('demand_demand', 'audit_status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demand.audit_status'
        db.delete_column('demand_demand', 'audit_status')
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 31, 0, 0)'}),
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 31, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 31, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
