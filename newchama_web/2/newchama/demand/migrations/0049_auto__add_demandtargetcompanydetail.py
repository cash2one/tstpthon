...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemandTargetCompanyDetail'
        db.create_table('demand_target_company_detail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_detail', to=orm['demand.Demand'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_detail_company', to=orm['member.Company'])),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_detail_member', to=orm['member.Member'])),
        ...
        db.send_create_signal(u'demand', ['DemandTargetCompanyDetail'])


    def backwards(self, orm):
        # Deleting model 'DemandTargetCompanyDetail'
        db.delete_table('demand_target_company_detail')
    ...
    models = {
        ...
        u'demand.demandtargetcompanydetail': {
            'Meta': {'object_name': 'DemandTargetCompanyDetail', 'db_table': "'demand_target_company_detail'"},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'demand_detail_company'", 'to': u"orm['member.Company']"}),
