...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('demand_demandindustry', 'cv1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DemandIndustry.cv2'
        db.add_column('demand_demandindustry', 'cv2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DemandIndustry.cv3'
        db.add_column('demand_demandindustry', 'cv3',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('demand_demandindustry', 'cv1')

        # Deleting field 'DemandIndustry.cv2'
        db.delete_column('demand_demandindustry', 'cv2')

        # Deleting field 'DemandIndustry.cv3'
        db.delete_column('demand_demandindustry', 'cv3')
