...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemandDownloadLog'
        db.create_table('demand_download_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_download_log_member', to=orm['member.Member'])),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_download_log_demand', to=orm['demand.Demand'])),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'demand', ['DemandDownloadLog'])

        # Adding model 'DemandPrintLog'
        db.create_table('demand_print_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_print_log_member', to=orm['member.Member'])),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_print_log_demand', to=orm['demand.Demand'])),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'demand', ['DemandPrintLog'])


    def backwards(self, orm):
        # Deleting model 'DemandDownloadLog'
        db.delete_table('demand_download_log')

        # Deleting model 'DemandPrintLog'
        db.delete_table('demand_print_log')
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'expected_enterprice_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '2'}),
