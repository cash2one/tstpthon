...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemandRecommondReasonAdmin'
        db.create_table('demand_admin_recommond_reason', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_recommond_reason_admin', to=orm['demand.Demand'])),
            ('reason', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'demand', ['DemandRecommondReasonAdmin'])


        # Changing field 'DemandTargetProjectDetail.add_time'
        db.alter_column('demand_target_project_detail', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'DemandCheckLog.add_time'
        db.alter_column('demand_check_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'DemandViewLog.add_time'
        db.alter_column('demand_view_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Demand.add_time'
        db.alter_column('demand_demand', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'DemandDownloadLog.add_time'
        db.alter_column('demand_download_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'DemandPrintLog.add_time'
        db.alter_column('demand_print_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'DemandRecommondReasonAdmin'
        db.delete_table('demand_admin_recommond_reason')


        # Changing field 'DemandTargetProjectDetail.add_time'
        db.alter_column('demand_target_project_detail', 'add_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'DemandCheckLog.add_time'
        db.alter_column('demand_check_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'DemandViewLog.add_time'
        db.alter_column('demand_view_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Demand.add_time'
        db.alter_column('demand_demand', 'add_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'DemandDownloadLog.add_time'
        db.alter_column('demand_download_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'DemandPrintLog.add_time'
        db.alter_column('demand_print_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'demand.demandrecommondreasonadmin': {
            'Meta': {'object_name': 'DemandRecommondReasonAdmin', 'db_table': "'demand_admin_recommond_reason'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'demand_recommond_reason_admin'", 'to': u"orm['demand.Demand']"}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
