...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Demand.expected_enterprice_value'
        db.alter_column('demand_demand', 'expected_enterprice_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
