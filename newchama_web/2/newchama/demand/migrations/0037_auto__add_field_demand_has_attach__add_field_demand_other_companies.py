...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demand.has_attach'
        db.add_column('demand_demand', 'has_attach',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Demand.other_companies'
        db.add_column('demand_demand', 'other_companies',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demand.has_attach'
        db.delete_column('demand_demand', 'has_attach')

        # Deleting field 'Demand.other_companies'
        db.delete_column('demand_demand', 'other_companies')
