...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemandKeywordAdmin'
        db.create_table('demand_keyword_Admin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_keyword_admin', to=orm['demand.Demand'])),
            ('keyword', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'demand', ['DemandKeywordAdmin'])

        # Adding model 'DemandKeywordEn'
        db.create_table('demand_keyword_en', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_keyword_en', to=orm['demand.Demand'])),
            ('keyword', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'demand', ['DemandKeywordEn'])


    def backwards(self, orm):
        # Deleting model 'DemandKeywordAdmin'
        db.delete_table('demand_keyword_Admin')

        # Deleting model 'DemandKeywordEn'
        db.delete_table('demand_keyword_en')
