...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field company_cities on 'Demand'
        m2m_table_name = db.shorten_name('demand_demand_company_cities')
        ...
        db.create_unique(m2m_table_name, ['demand_id', 'city_id'])


    def backwards(self, orm):
        # Removing M2M table for field company_cities on 'Demand'
        db.delete_table(db.shorten_name('demand_demand_company_cities'))
