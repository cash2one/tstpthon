...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemandAttach'
        db.create_table('demand_demandAttach', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_attach', to=orm['demand.Demand'])),
        ...
        db.send_create_signal(u'demand', ['DemandAttach'])

        # Adding field 'Demand.stock_structure_percentage_type_private'
        db.add_column('demand_demand', 'stock_structure_percentage_type_private',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Demand.name_project_en'
        db.add_column('demand_demand', 'name_project_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Demand.expected_enterprice_value'
        db.add_column('demand_demand', 'expected_enterprice_value',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DemandAttach'
        db.delete_table('demand_demandAttach')

        # Deleting field 'Demand.stock_structure_percentage_type_private'
        db.delete_column('demand_demand', 'stock_structure_percentage_type_private')

        # Deleting field 'Demand.name_project_en'
        db.delete_column('demand_demand', 'name_project_en')

        # Deleting field 'Demand.expected_enterprice_value'
        db.delete_column('demand_demand', 'expected_enterprice_value')
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_project_en': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
        ...
        u'demand.demandattach': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'demand_attach'", 'to': u"orm['demand.Demand']"})
        },
