...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DemandIndustry.cv2'
        db.delete_column(u'demand_demandindustry', 'cv2')

        # Deleting field 'DemandIndustry.cv3'
        db.delete_column(u'demand_demandindustry', 'cv3')

        # Deleting field 'DemandIndustry.cv1'
        db.delete_column(u'demand_demandindustry', 'cv1')


    def backwards(self, orm):
        # Adding field 'DemandIndustry.cv2'
        db.add_column(u'demand_demandindustry', 'cv2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DemandIndustry.cv3'
        db.add_column(u'demand_demandindustry', 'cv3',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DemandIndustry.cv1'
        db.add_column(u'demand_demandindustry', 'cv1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 27, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 27, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
