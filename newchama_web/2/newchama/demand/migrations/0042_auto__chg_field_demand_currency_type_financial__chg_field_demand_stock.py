...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Demand.currency_type_financial'
        db.alter_column('demand_demand', 'currency_type_financial', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.stock_structure_percentage_type_management'
        db.alter_column('demand_demand', 'stock_structure_percentage_type_management', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.total_assets_last_phase'
        db.alter_column('demand_demand', 'total_assets_last_phase', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.registered_capital'
        db.alter_column('demand_demand', 'registered_capital', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.profit'
        db.alter_column('demand_demand', 'profit', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.income'
        db.alter_column('demand_demand', 'income', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.service_type'
        db.alter_column('demand_demand', 'service_type', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.deal_size'
        db.alter_column('demand_demand', 'deal_size', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.net_assets'
        db.alter_column('demand_demand', 'net_assets', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.employees_count_type'
        db.alter_column('demand_demand', 'employees_count_type', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.stock_structure_percentage_type_institutional'
        db.alter_column('demand_demand', 'stock_structure_percentage_type_institutional', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.profit_last_phase'
        db.alter_column('demand_demand', 'profit_last_phase', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.expected_enterprice_value'
        db.alter_column('demand_demand', 'expected_enterprice_value', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.stock_structure_percentage_type_private'
        db.alter_column('demand_demand', 'stock_structure_percentage_type_private', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Demand.income_last_phase'
        db.alter_column('demand_demand', 'income_last_phase', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Demand.currency_type_financial'
        db.alter_column('demand_demand', 'currency_type_financial', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.stock_structure_percentage_type_management'
        db.alter_column('demand_demand', 'stock_structure_percentage_type_management', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.total_assets_last_phase'
        db.alter_column('demand_demand', 'total_assets_last_phase', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.registered_capital'
        db.alter_column('demand_demand', 'registered_capital', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.profit'
        db.alter_column('demand_demand', 'profit', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.income'
        db.alter_column('demand_demand', 'income', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.service_type'
        db.alter_column('demand_demand', 'service_type', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.deal_size'
        db.alter_column('demand_demand', 'deal_size', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.net_assets'
        db.alter_column('demand_demand', 'net_assets', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.employees_count_type'
        db.alter_column('demand_demand', 'employees_count_type', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.stock_structure_percentage_type_institutional'
        db.alter_column('demand_demand', 'stock_structure_percentage_type_institutional', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.profit_last_phase'
        db.alter_column('demand_demand', 'profit_last_phase', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.expected_enterprice_value'
        db.alter_column('demand_demand', 'expected_enterprice_value', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.stock_structure_percentage_type_private'
        db.alter_column('demand_demand', 'stock_structure_percentage_type_private', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Demand.income_last_phase'
        db.alter_column('demand_demand', 'income_last_phase', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'financial_year': ('django.db.models.fields.IntegerField', [], {'default': '2014'}),
            'growth_three_year': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2'}),
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 30, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
