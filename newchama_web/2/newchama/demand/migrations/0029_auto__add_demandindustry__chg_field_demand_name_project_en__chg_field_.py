...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemandIndustry'
        db.create_table(u'demand_demandindustry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demand_industries', to=orm['demand.Demand'])),
        ...
        db.send_create_signal(u'demand', ['DemandIndustry'])


        # Changing field 'Demand.name_project_en'
        db.alter_column('demand_demand', 'name_project_en', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Demand.name_project_cn'
        db.alter_column('demand_demand', 'name_project_cn', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Demand.expected_enterprice_value'
        db.alter_column('demand_demand', 'expected_enterprice_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Demand.growth_three_year'
        db.alter_column('demand_demand', 'growth_three_year', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting model 'DemandIndustry'
        db.delete_table(u'demand_demandindustry')


        # Changing field 'Demand.name_project_en'
        db.alter_column('demand_demand', 'name_project_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Demand.name_project_cn'
        db.alter_column('demand_demand', 'name_project_cn', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Demand.expected_enterprice_value'
        db.alter_column('demand_demand', 'expected_enterprice_value', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Demand.growth_three_year'
        db.alter_column('demand_demand', 'growth_three_year', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'expected_enterprice_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            ...
            'growth_three_year': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_project_cn': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'name_project_en': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            ...
            'stock_structure_percentage_type_private': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 24, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 24, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
