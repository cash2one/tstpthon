...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Industry.is_display'
        db.add_column('industry_industry', 'is_display',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Industry.is_display'
        db.delete_column('industry_industry', 'is_display')
