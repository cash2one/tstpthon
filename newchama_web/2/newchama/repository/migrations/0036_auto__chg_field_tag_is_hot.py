...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tag.is_hot'
        db.alter_column('tag', 'is_hot', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Tag.is_hot'
        db.alter_column('tag', 'is_hot', self.gf('django.db.models.fields.BooleanField')())
