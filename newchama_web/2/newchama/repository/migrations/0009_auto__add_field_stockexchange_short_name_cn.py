...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockExchange.short_name_cn'
        db.add_column('repository_stockexchange', 'short_name_cn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StockExchange.short_name_cn'
        db.delete_column('repository_stockexchange', 'short_name_cn')
