...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ListedCompany.invest_filed'
        db.delete_column(u'repository_listedcompany', 'invest_filed')

        # Adding field 'ListedCompany.invest_field'
        db.add_column('repository_listedcompany', 'invest_field',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvestmentCompany.invest_filed'
        db.delete_column(u'repository_investmentcompany', 'invest_filed')

        # Adding field 'InvestmentCompany.invest_field'
        db.add_column('repository_investmentcompany', 'invest_field',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ListedCompany.invest_filed'
        db.add_column(u'repository_listedcompany', 'invest_filed',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ListedCompany.invest_field'
        db.delete_column('repository_listedcompany', 'invest_field')

        # Adding field 'InvestmentCompany.invest_filed'
        db.add_column(u'repository_investmentcompany', 'invest_filed',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvestmentCompany.invest_field'
        db.delete_column('repository_investmentcompany', 'invest_field')
