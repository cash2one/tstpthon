...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tags.sub_name'
        db.alter_column('tag_category', 'sub_name', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Tags.sub_name'
        db.alter_column('tag_category', 'sub_name', self.gf('django.db.models.fields.IntegerField')())
