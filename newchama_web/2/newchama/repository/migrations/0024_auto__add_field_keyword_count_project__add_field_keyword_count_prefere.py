...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('repository_keyword', 'count_project',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Keyword.count_preference'
        db.add_column('repository_keyword', 'count_preference',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Keyword.add_time'
        db.add_column('repository_keyword', 'add_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Keyword.update_time'
        db.add_column('repository_keyword', 'update_time',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('repository_keyword', 'count_project')

        # Deleting field 'Keyword.count_preference'
        db.delete_column('repository_keyword', 'count_preference')

        # Deleting field 'Keyword.add_time'
        db.delete_column('repository_keyword', 'add_time')

        # Deleting field 'Keyword.update_time'
        db.delete_column('repository_keyword', 'update_time')
