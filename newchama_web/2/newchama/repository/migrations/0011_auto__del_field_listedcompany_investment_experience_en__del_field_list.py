...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ListedCompany.investment_experience_en'
        #db.delete_column(u'repository_listedcompany', 'investment_experience_en')

        # Deleting field 'ListedCompany.investment_experience_cn'
        #db.delete_column(u'repository_listedcompany', 'investment_experience_cn')

        # Adding field 'ListedCompany.city'
        #db.add_column('repository_listedcompany', 'city',
        ...
        #db.add_column('repository_listedcompany', 'stock_symbol_no_pre',
                      #self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      #keep_default=False)

        # Adding field 'ListedCompany.stock_name'
        db.add_column('repository_listedcompany', 'stock_name',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'ListedCompany.found_time'
        db.add_column('repository_listedcompany', 'found_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ListedCompany.investment_experience_en'
        #db.add_column(u'repository_listedcompany', 'investment_experience_en',
                      #self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      #keep_default=False)

        # Adding field 'ListedCompany.investment_experience_cn'
        #db.add_column(u'repository_listedcompany', 'investment_experience_cn',
                      #self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      #keep_default=False)

        # Deleting field 'ListedCompany.city'
        db.delete_column('repository_listedcompany', 'city_id')

        # Deleting field 'ListedCompany.stock_symbol_no_pre'
        db.delete_column('repository_listedcompany', 'stock_symbol_no_pre')

        # Deleting field 'ListedCompany.stock_name'
        db.delete_column('repository_listedcompany', 'stock_name')

        # Deleting field 'ListedCompany.found_time'
        db.delete_column('repository_listedcompany', 'found_time')
