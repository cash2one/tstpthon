...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tag.is_delete'
        db.alter_column('tag', 'is_delete', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Tag.is_delete'
        db.alter_column('tag', 'is_delete', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'repository.tag': {
            ...
            'is_hot': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True'}),
