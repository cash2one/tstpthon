...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ListedCompany.invest_filed'
        db.alter_column('repository_listedcompany', 'invest_filed', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'InvestmentCompany.invest_filed'
        db.alter_column('repository_investmentcompany', 'invest_filed', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'ListedCompany.invest_filed'
        db.alter_column('repository_listedcompany', 'invest_filed', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'InvestmentCompany.invest_filed'
        db.alter_column('repository_investmentcompany', 'invest_filed', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))
    ...
    models = {
        ...
        u'repository.investmentcompany': {
            ...
            'invest_filed': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
