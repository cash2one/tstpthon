...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ListedCompany.invest_type'
        db.add_column('repository_listedcompany', 'invest_type',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ListedCompany.invest_size'
        db.add_column('repository_listedcompany', 'invest_size',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ListedCompany.invest_type'
        db.delete_column('repository_listedcompany', 'invest_type')

        # Deleting field 'ListedCompany.invest_size'
        db.delete_column('repository_listedcompany', 'invest_size')
