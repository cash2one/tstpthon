...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'repository_keyword')


    def backwards(self, orm):
        # Adding model 'Keyword'
        db.create_table(u'repository_keyword', (
            ...
            ('count_project', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('count_preference', self.gf('django.db.models.fields.IntegerField')(default=0)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'repository', ['Keyword'])
