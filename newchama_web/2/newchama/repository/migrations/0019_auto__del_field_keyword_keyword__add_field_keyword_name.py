...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Keyword.keyword'
        db.delete_column(u'repository_keyword', 'keyword')

        # Adding field 'Keyword.name'
        db.add_column('repository_keyword', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Keyword.keyword'
        db.add_column(u'repository_keyword', 'keyword',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'Keyword.name'
        db.delete_column('repository_keyword', 'name')
