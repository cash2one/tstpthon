...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('repository_listedcompany', 'invest_filed')

        # Deleting field 'InvestmentCompany.invest_filed'
        db.delete_column('repository_investmentcompany', 'invest_filed')
    ...
    models = {
        ...
        u'repository.investmentcompany': {
            ...
            'invest_filed': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
