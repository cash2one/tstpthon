...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ListedCompany.memo'
        db.add_column('repository_listedcompany', 'memo',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InvestmentCompany.memo'
        db.add_column('repository_investmentcompany', 'memo',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ListedCompany.memo'
        db.delete_column('repository_listedcompany', 'memo')

        # Deleting field 'InvestmentCompany.memo'
        db.delete_column('repository_investmentcompany', 'memo')
