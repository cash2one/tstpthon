...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ListedCompany.stock_symbol_has_prefix'
        db.add_column(u'repository_listedcompany', 'stock_symbol_has_prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ListedCompany.stock_symbol_has_prefix'
        db.delete_column(u'repository_listedcompany', 'stock_symbol_has_prefix')
    ...
    models = {
        ...
        u'repository.listedcompany': {
            ...
            'stock_symbol_has_prefix': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
