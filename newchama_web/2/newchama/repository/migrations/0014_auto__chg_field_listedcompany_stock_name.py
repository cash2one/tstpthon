...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ListedCompany.stock_name'
        db.alter_column('repository_listedcompany', 'stock_name', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'ListedCompany.stock_name'
        db.alter_column('repository_listedcompany', 'stock_name', self.gf('django.db.models.fields.TextField')(max_length=20))
