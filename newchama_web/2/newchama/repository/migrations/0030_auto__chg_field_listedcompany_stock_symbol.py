...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('repository_listedcompany', 'stock_symbol', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'ListedCompany.stock_symbol'
        db.alter_column('repository_listedcompany', 'stock_symbol', self.gf('django.db.models.fields.CharField')(max_length=20))
