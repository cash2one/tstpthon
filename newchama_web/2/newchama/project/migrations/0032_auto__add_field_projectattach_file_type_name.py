...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectAttach.file_type_name'
        db.add_column('project_projectAttach', 'file_type_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectAttach.file_type_name'
        db.delete_column('project_projectAttach', 'file_type_name')
