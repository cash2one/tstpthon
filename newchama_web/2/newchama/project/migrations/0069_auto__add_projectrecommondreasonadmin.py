...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectRecommondReasonAdmin'
        db.create_table('project_admin_recommond_reason', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_recommond_reason_admin', to=orm['project.Project'])),
            ('reason', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'project', ['ProjectRecommondReasonAdmin'])


    def backwards(self, orm):
        # Deleting model 'ProjectRecommondReasonAdmin'
        db.delete_table('project_admin_recommond_reason')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
