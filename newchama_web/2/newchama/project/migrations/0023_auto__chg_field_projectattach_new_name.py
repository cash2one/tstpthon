...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectAttach.new_name'
        db.alter_column('project_projectAttach', 'new_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ProjectAttach.new_name'
        db.alter_column('project_projectAttach', 'new_name', self.gf('django.db.models.fields.CharField')(max_length=10))
