...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectViewLog.add_time'
        db.alter_column('project_view_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProjectDownloadLog.add_time'
        db.alter_column('project_download_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Project.add_time'
        db.alter_column('project_project', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProjectPrintLog.add_time'
        db.alter_column('project_print_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProjectCheckLog.add_time'
        db.alter_column('project_check_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProjectOneclickAttach.add_time'
        db.alter_column('project_oneclickAttach', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProjectRecommendLog.add_time'
        db.alter_column('project_recommend_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'ProjectViewLog.add_time'
        db.alter_column('project_view_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ProjectDownloadLog.add_time'
        db.alter_column('project_download_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Project.add_time'
        db.alter_column('project_project', 'add_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ProjectPrintLog.add_time'
        db.alter_column('project_print_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ProjectCheckLog.add_time'
        db.alter_column('project_check_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ProjectOneclickAttach.add_time'
        db.alter_column('project_oneclickAttach', 'add_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ProjectRecommendLog.add_time'
        db.alter_column('project_recommend_log', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
