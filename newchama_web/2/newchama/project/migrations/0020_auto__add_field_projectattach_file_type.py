...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectAttach.file_type'
        db.add_column('project_projectAttach', 'file_type',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectAttach.file_type'
        db.delete_column('project_projectAttach', 'file_type')
