...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectRecommendLog'
        db.create_table('project_recommend_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_recommend_log_project', to=orm['project.Project'])),
        ...
        db.send_create_signal(u'project', ['ProjectRecommendLog'])


    def backwards(self, orm):
        # Deleting model 'ProjectRecommendLog'
        db.delete_table('project_recommend_log')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 15, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
