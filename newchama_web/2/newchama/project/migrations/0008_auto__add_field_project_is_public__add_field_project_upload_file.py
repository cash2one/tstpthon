...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.is_public'
        db.add_column(u'project_project', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.upload_file'
        db.add_column(u'project_project', 'upload_file',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.is_public'
        db.delete_column(u'project_project', 'is_public')

        # Deleting field 'Project.upload_file'
        db.delete_column(u'project_project', 'upload_file')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
