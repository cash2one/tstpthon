...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.target_platform'
        db.add_column('project_project', 'target_platform',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.target_platform'
        db.delete_column('project_project', 'target_platform')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
