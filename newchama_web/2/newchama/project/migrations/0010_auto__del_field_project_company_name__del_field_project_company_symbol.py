...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.company_symbol_en'
        db.add_column('project_project', 'company_symbol_en',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Project.company_name_cn'
        db.add_column('project_project', 'company_name_cn',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.company_symbol_en'
        db.delete_column('project_project', 'company_symbol_en')

        # Deleting field 'Project.company_name_cn'
        db.delete_column('project_project', 'company_name_cn')
