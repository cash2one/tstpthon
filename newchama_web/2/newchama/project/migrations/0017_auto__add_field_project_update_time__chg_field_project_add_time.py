...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.update_time'
        db.add_column('project_project', 'update_time',
    ...
    def backwards(self, orm):
        # Deleting field 'Project.update_time'
        db.delete_column('project_project', 'update_time')


        # Changing field 'Project.add_time'
        db.alter_column('project_project', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
