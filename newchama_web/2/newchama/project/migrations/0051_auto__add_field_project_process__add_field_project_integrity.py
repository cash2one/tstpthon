...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.process'
        db.add_column('project_project', 'process',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.integrity'
        db.add_column('project_project', 'integrity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.process'
        db.delete_column('project_project', 'process')

        # Deleting field 'Project.integrity'
        db.delete_column('project_project', 'integrity')
