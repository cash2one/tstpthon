...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ProjectTargetCompanyDetail'
        db.delete_table('project_target_company_detail')


        # Changing field 'Project.audit_status'
        db.alter_column('project_project', 'audit_status', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.audit_status_3'
        db.alter_column('project_project', 'audit_status_3', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.audit_status_2'
        db.alter_column('project_project', 'audit_status_2', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Adding model 'ProjectTargetCompanyDetail'
        db.create_table('project_target_company_detail', (
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_detail_member', to=orm['member.Member'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_detail', to=orm['project.Project'])),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('recommend_type', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('is_delete', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('update_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_detail_update_member', null=True, to=orm['member.Member'], blank=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_detail_company', to=orm['member.Company'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 15, 0, 0))),
        ))
        db.send_create_signal(u'project', ['ProjectTargetCompanyDetail'])


        # Changing field 'Project.audit_status'
        db.alter_column('project_project', 'audit_status', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Project.audit_status_3'
        db.alter_column('project_project', 'audit_status_3', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Project.audit_status_2'
        db.alter_column('project_project', 'audit_status_2', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
