...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.other_companies'
        db.delete_column(u'project_project', 'other_companies')

        # Adding field 'Project.other_target_companies'
        db.add_column('project_project', 'other_target_companies',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.other_companies'
        db.add_column(u'project_project', 'other_companies',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Deleting field 'Project.other_target_companies'
        db.delete_column('project_project', 'other_target_companies')
    ...
    models = {
        ...
        u'project.project': {
            ...
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'other_target_companies': ('django.db.models.fields.TextField', [], {'null': 'True'}),
