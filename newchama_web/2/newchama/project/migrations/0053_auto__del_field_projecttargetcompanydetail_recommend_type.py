...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectTargetCompanyDetail.recommend_type'
        db.delete_column('project_target_company_detail', 'recommend_type')


    def backwards(self, orm):
        # Adding field 'ProjectTargetCompanyDetail.recommend_type'
        db.add_column('project_target_company_detail', 'recommend_type',
    ...
    models = {
        ...
        u'project.projecttargetcompanydetail': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'detail_company'", 'to': u"orm['member.Company']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'detail_member'", 'to': u"orm['member.Member']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'detail_target'", 'to': u"orm['project.Project']"})
        },
