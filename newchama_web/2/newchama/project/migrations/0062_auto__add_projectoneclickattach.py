...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectOneclickAttach'
        db.create_table('project_oneclickAttach', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('file_size', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True)),
            ('file_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('new_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='onclick_publisher', to=orm['member.Member'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_oneclick_attach', null=True, to=orm['project.Project'])),
        ))
        db.send_create_signal(u'project', ['ProjectOneclickAttach'])


    def backwards(self, orm):
        # Deleting model 'ProjectOneclickAttach'
        db.delete_table('project_oneclickAttach')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 12, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
