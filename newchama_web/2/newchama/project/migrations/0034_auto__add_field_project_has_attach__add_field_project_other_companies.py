...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.has_attach'
        db.add_column('project_project', 'has_attach',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.other_companies'
        db.add_column('project_project', 'other_companies',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.has_attach'
        db.delete_column('project_project', 'has_attach')

        # Deleting field 'Project.other_companies'
        db.delete_column('project_project', 'other_companies')
    ...
    models = {
        ...
        u'project.project': {
            ...
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'other_companies': ('django.db.models.fields.TextField', [], {'null': 'True'}),
