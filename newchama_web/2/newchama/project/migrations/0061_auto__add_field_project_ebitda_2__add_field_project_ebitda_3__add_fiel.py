...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.ebitda_2'
        db.add_column('project_project', 'ebitda_2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.ebitda_3'
        db.add_column('project_project', 'ebitda_3',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.audit_status'
        db.add_column('project_project', 'audit_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.audit_status_2'
        db.add_column('project_project', 'audit_status_2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.audit_status_3'
        db.add_column('project_project', 'audit_status_3',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.ebitda_2'
        db.delete_column('project_project', 'ebitda_2')

        # Deleting field 'Project.ebitda_3'
        db.delete_column('project_project', 'ebitda_3')

        # Deleting field 'Project.audit_status'
        db.delete_column('project_project', 'audit_status')

        # Deleting field 'Project.audit_status_2'
        db.delete_column('project_project', 'audit_status_2')

        # Deleting field 'Project.audit_status_3'
        db.delete_column('project_project', 'audit_status_3')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 9, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 9, 0, 0)'}),
            'audit_status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'audit_status_2': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'audit_status_3': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.projecttargetcompanydetail': {
            'Meta': {'object_name': 'ProjectTargetCompanyDetail', 'db_table': "'project_target_company_detail'"},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 9, 0, 0)'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'project_detail_company'", 'to': u"orm['member.Company']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_delete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'project_detail_member'", 'to': u"orm['member.Member']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'project_detail'", 'to': u"orm['project.Project']"}),
            'recommend_type': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'update_member': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'project_detail_update_member'", 'null': 'True', 'to': u"orm['member.Member']"}),
