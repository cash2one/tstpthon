...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.currency_type_service'
        db.alter_column('project_project', 'currency_type_service', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.profit'
        db.alter_column('project_project', 'profit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2))

        # Changing field 'Project.financial_year'
        db.alter_column('project_project', 'financial_year', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.total_assets_last_phase'
        db.alter_column('project_project', 'total_assets_last_phase', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2))

        # Changing field 'Project.registered_capital'
        db.alter_column('project_project', 'registered_capital', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Project.service_type'
        db.alter_column('project_project', 'service_type', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.income_last_phase'
        db.alter_column('project_project', 'income_last_phase', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2))

        # Changing field 'Project.income'
        db.alter_column('project_project', 'income', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2))

        # Changing field 'Project.stock_percent'
        db.alter_column('project_project', 'stock_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

        # Changing field 'Project.employees_count_type'
        db.alter_column('project_project', 'employees_count_type', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.profit_last_phase'
        db.alter_column('project_project', 'profit_last_phase', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2))

        # Changing field 'Project.expected_enterprice_value'
        db.alter_column('project_project', 'expected_enterprice_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2))

        # Changing field 'Project.ebitda'
        db.alter_column('project_project', 'ebitda', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Project.currency_type_service'
        db.alter_column('project_project', 'currency_type_service', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Project.profit'
        db.alter_column('project_project', 'profit', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

        # Changing field 'Project.financial_year'
        db.alter_column('project_project', 'financial_year', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Project.total_assets_last_phase'
        db.alter_column('project_project', 'total_assets_last_phase', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

        # Changing field 'Project.registered_capital'
        db.alter_column('project_project', 'registered_capital', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Project.service_type'
        db.alter_column('project_project', 'service_type', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Project.income_last_phase'
        db.alter_column('project_project', 'income_last_phase', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

        # Changing field 'Project.income'
        db.alter_column('project_project', 'income', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

        # Changing field 'Project.stock_percent'
        db.alter_column('project_project', 'stock_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Project.employees_count_type'
        db.alter_column('project_project', 'employees_count_type', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Project.profit_last_phase'
        db.alter_column('project_project', 'profit_last_phase', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

        # Changing field 'Project.expected_enterprice_value'
        db.alter_column('project_project', 'expected_enterprice_value', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

        # Changing field 'Project.ebitda'
        db.alter_column('project_project', 'ebitda', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))
