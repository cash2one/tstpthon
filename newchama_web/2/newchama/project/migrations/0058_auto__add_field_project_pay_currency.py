...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.pay_currency'
        db.add_column('project_project', 'pay_currency',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.pay_currency'
        db.delete_column('project_project', 'pay_currency')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
