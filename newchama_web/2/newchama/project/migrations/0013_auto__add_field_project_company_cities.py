...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.company_cities'
        db.add_column('project_project', 'company_cities',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.City'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field company_cities on 'Project'
        db.delete_table(db.shorten_name(u'project_project_company_cities'))


    def backwards(self, orm):
        # Deleting field 'Project.company_cities'
        db.delete_column('project_project', 'company_cities_id')

        # Adding M2M table for field company_cities on 'Project'
        m2m_table_name = db.shorten_name(u'project_project_company_cities')
        ...
        db.create_unique(m2m_table_name, ['project_id', 'city_id'])
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
