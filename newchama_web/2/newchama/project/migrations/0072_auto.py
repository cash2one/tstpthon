...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field deal_type on 'Project'
        m2m_table_name = db.shorten_name('project_project_deal_type')
        ...
        db.create_unique(m2m_table_name, ['project_id', 'detaildealtype_id'])


    def backwards(self, orm):
        # Removing M2M table for field deal_type on 'Project'
        db.delete_table(db.shorten_name('project_project_deal_type'))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 17, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 17, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
