...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectCheckLog'
        db.create_table('project_check_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('adminuser', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_check_log_adminuser', to=orm['adminuser.AdminUser'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_check_log_project', to=orm['project.Project'])),
        ...
        db.send_create_signal(u'project', ['ProjectCheckLog'])


    def backwards(self, orm):
        # Deleting model 'ProjectCheckLog'
        db.delete_table('project_check_log')
