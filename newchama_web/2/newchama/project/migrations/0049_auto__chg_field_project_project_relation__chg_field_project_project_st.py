...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.project_relation'
        db.alter_column('project_project', 'project_relation', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.project_stage'
        db.alter_column('project_project', 'project_stage', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.project_relation'
        db.alter_column('project_project', 'project_relation', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Project.project_stage'
        db.alter_column('project_project', 'project_stage', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
