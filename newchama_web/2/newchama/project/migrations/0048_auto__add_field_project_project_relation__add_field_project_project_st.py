...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.project_relation'
        db.add_column('project_project', 'project_relation',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Project.project_stage'
        db.add_column('project_project', 'project_stage',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Project.income_last_phase_2'
        db.add_column('project_project', 'income_last_phase_2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.profit_last_phase_2'
        db.add_column('project_project', 'profit_last_phase_2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.income_last_phase_3'
        db.add_column('project_project', 'income_last_phase_3',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.profit_last_phase_3'
        db.add_column('project_project', 'profit_last_phase_3',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.total_assets_last_phase_2'
        db.add_column('project_project', 'total_assets_last_phase_2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.total_assets_last_phase_3'
        db.add_column('project_project', 'total_assets_last_phase_3',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.total_profit_last_phase'
        db.add_column('project_project', 'total_profit_last_phase',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.total_profit_last_phase_2'
        db.add_column('project_project', 'total_profit_last_phase_2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.total_profit_last_phase_3'
        db.add_column('project_project', 'total_profit_last_phase_3',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Project.income_type'
        db.add_column('project_project', 'income_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.profit_type'
        db.add_column('project_project', 'profit_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.project_relation'
        db.delete_column('project_project', 'project_relation')

        # Deleting field 'Project.project_stage'
        db.delete_column('project_project', 'project_stage')

        # Deleting field 'Project.income_last_phase_2'
        db.delete_column('project_project', 'income_last_phase_2')

        # Deleting field 'Project.profit_last_phase_2'
        db.delete_column('project_project', 'profit_last_phase_2')

        # Deleting field 'Project.income_last_phase_3'
        db.delete_column('project_project', 'income_last_phase_3')

        # Deleting field 'Project.profit_last_phase_3'
        db.delete_column('project_project', 'profit_last_phase_3')

        # Deleting field 'Project.total_assets_last_phase_2'
        db.delete_column('project_project', 'total_assets_last_phase_2')

        # Deleting field 'Project.total_assets_last_phase_3'
        db.delete_column('project_project', 'total_assets_last_phase_3')

        # Deleting field 'Project.total_profit_last_phase'
        db.delete_column('project_project', 'total_profit_last_phase')

        # Deleting field 'Project.total_profit_last_phase_2'
        db.delete_column('project_project', 'total_profit_last_phase_2')

        # Deleting field 'Project.total_profit_last_phase_3'
        db.delete_column('project_project', 'total_profit_last_phase_3')

        # Deleting field 'Project.income_type'
        db.delete_column('project_project', 'income_type')

        # Deleting field 'Project.profit_type'
        db.delete_column('project_project', 'profit_type')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 20, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'project_relation': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'project_stage': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
