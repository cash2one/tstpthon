...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.deal_size'
        db.add_column('project_project', 'deal_size',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.stock_percent'
        db.add_column('project_project', 'stock_percent',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.ebitda'
        db.add_column('project_project', 'ebitda',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.deal_size'
        db.delete_column('project_project', 'deal_size')

        # Deleting field 'Project.stock_percent'
        db.delete_column('project_project', 'stock_percent')

        # Deleting field 'Project.ebitda'
        db.delete_column('project_project', 'ebitda')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 25, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 25, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'ebitda': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
