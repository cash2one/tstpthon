...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectCustomerTargetCompany'
        db.create_table('project_customer_target_company', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_customer_target_company', to=orm['project.Project'])),
            ('company_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('company_name_cn', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('company_name_en', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('company_short_name_cn', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('company_short_name_en', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ...
            ('company_field', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('company_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('target_reason', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'project', ['ProjectCustomerTargetCompany'])


    def backwards(self, orm):
        # Deleting model 'ProjectCustomerTargetCompany'
        db.delete_table('project_customer_target_company')
    ...
    models = {
        ...
        u'project.projectcustomertargetcompany': {
            ...
            'company_field': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'company_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'company_name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'company_name_en': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'company_short_name_cn': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'company_short_name_en': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            ...
            'target_reason': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
