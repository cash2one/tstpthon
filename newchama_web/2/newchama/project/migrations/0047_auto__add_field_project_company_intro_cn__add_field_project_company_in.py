...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.company_intro_cn'
        db.add_column('project_project', 'company_intro_cn',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.company_intro_en'
        db.add_column('project_project', 'company_intro_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.company_industry_intro_cn'
        db.add_column('project_project', 'company_industry_intro_cn',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.company_industry_intro_en'
        db.add_column('project_project', 'company_industry_intro_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.company_intro_cn'
        db.delete_column('project_project', 'company_intro_cn')

        # Deleting field 'Project.company_intro_en'
        db.delete_column('project_project', 'company_intro_en')

        # Deleting field 'Project.company_industry_intro_cn'
        db.delete_column('project_project', 'company_industry_intro_cn')

        # Deleting field 'Project.company_industry_intro_en'
        db.delete_column('project_project', 'company_industry_intro_en')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 25, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 25, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
