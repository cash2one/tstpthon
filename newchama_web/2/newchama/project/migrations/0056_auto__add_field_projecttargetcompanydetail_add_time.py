...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectTargetCompanyDetail.add_time'
        db.add_column('project_target_company_detail', 'add_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectTargetCompanyDetail.add_time'
        db.delete_column('project_target_company_detail', 'add_time')
