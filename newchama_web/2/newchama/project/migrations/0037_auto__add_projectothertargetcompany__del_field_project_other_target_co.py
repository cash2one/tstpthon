...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectOtherTargetCompany'
        db.create_table('project_other_target_company', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_other_company', to=orm['project.Project'])),
            ...
            ('short_name_cn', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('short_name_en', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('table_name', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'project', ['ProjectOtherTargetCompany'])

        # Deleting field 'Project.other_target_companies'
        db.delete_column(u'project_project', 'other_target_companies')


    def backwards(self, orm):
        # Deleting model 'ProjectOtherTargetCompany'
        db.delete_table('project_other_target_company')

        # Adding field 'Project.other_target_companies'
        db.add_column(u'project_project', 'other_target_companies',
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 26, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'registered_capital': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
