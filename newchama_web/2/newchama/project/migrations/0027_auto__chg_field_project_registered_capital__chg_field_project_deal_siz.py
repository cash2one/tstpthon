...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.deal_size'
        db.alter_column('project_project', 'deal_size', self.gf('django.db.models.fields.BigIntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.deal_size'
        db.alter_column('project_project', 'deal_size', self.gf('django.db.models.fields.IntegerField')(null=True))
