...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.status_check'
        db.add_column(u'project_project', 'status_check',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.is_list_company'
        db.add_column(u'project_project', 'is_list_company',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.expected_enterprice_value'
        db.add_column(u'project_project', 'expected_enterprice_value',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.is_anonymous'
        db.add_column(u'project_project', 'is_anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.status_check'
        db.delete_column(u'project_project', 'status_check')

        # Deleting field 'Project.is_list_company'
        db.delete_column(u'project_project', 'is_list_company')

        # Deleting field 'Project.expected_enterprice_value'
        db.delete_column(u'project_project', 'expected_enterprice_value')

        # Deleting field 'Project.is_anonymous'
        db.delete_column(u'project_project', 'is_anonymous')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'status': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'status_check': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
