...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectDownloadLog'
        db.create_table('project_download_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_download_log_member', to=orm['member.Member'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_download_log_project', to=orm['project.Project'])),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'project', ['ProjectDownloadLog'])

        # Adding model 'ProjectPrintLog'
        db.create_table('project_print_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_print_log_member', to=orm['member.Member'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_print_log_project', to=orm['project.Project'])),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'project', ['ProjectPrintLog'])


    def backwards(self, orm):
        # Deleting model 'ProjectDownloadLog'
        db.delete_table('project_download_log')

        # Deleting model 'ProjectPrintLog'
        db.delete_table('project_print_log')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 6, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'expected_enterprice_value': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '16', 'decimal_places': '2'}),
            ...
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'stock_percent': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
