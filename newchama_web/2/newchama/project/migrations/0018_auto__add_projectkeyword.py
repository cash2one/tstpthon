...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('project_keyword_project', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_keyword_project', to=orm['project.Project'])),
            ('keyword', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'project', ['ProjectKeyword'])


    def backwards(self, orm):
        # Deleting model 'ProjectKeyword'
        db.delete_table('project_keyword_project')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 15, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.projectkeyword': {
            'Meta': {'object_name': 'ProjectKeyword', 'db_table': "'project_keyword_project'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keyword': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'project_keyword_project'", 'to': u"orm['project.Project']"})
        },
