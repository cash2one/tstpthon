...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.cv1'
        db.add_column('project_project', 'cv1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.cv2'
        db.add_column('project_project', 'cv2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.cv3'
        db.add_column('project_project', 'cv3',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.cv1'
        db.delete_column('project_project', 'cv1')

        # Deleting field 'Project.cv2'
        db.delete_column('project_project', 'cv2')

        # Deleting field 'Project.cv3'
        db.delete_column('project_project', 'cv3')
