...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.regionlevelone'
        db.add_column('project_project', 'regionlevelone',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.RegionLevelOne'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.regionleveltwo'
        db.add_column('project_project', 'regionleveltwo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.RegionLevelTwo'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.regionlevelthree'
        db.add_column('project_project', 'regionlevelthree',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['area.RegionLevelThree'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.regionlevelone'
        db.delete_column('project_project', 'regionlevelone_id')

        # Deleting field 'Project.regionleveltwo'
        db.delete_column('project_project', 'regionleveltwo_id')

        # Deleting field 'Project.regionlevelthree'
        db.delete_column('project_project', 'regionlevelthree_id')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 10, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'regionlevelone': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['area.RegionLevelOne']", 'null': 'True', 'blank': 'True'}),
            'regionlevelthree': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['area.RegionLevelThree']", 'null': 'True', 'blank': 'True'}),
            'regionleveltwo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['area.RegionLevelTwo']", 'null': 'True', 'blank': 'True'}),
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 10, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
