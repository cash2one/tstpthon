...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCustomerTargetCompany.company_logo'
        db.add_column('project_customer_target_company', 'company_logo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectCustomerTargetCompany.company_logo'
        db.delete_column('project_customer_target_company', 'company_logo')
    ...
    models = {
        ...
        u'project.projectcustomertargetcompany': {
            ...
            'company_logo': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
