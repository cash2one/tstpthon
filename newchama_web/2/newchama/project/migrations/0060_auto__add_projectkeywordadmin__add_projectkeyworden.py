...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectKeywordAdmin'
        db.create_table('project_keyword_Admin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_keyword_admin', to=orm['project.Project'])),
            ('keyword', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'project', ['ProjectKeywordAdmin'])

        # Adding model 'ProjectKeywordEn'
        db.create_table('project_keyword_en', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_keyword_en', to=orm['project.Project'])),
            ('keyword', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'project', ['ProjectKeywordEn'])


    def backwards(self, orm):
        # Deleting model 'ProjectKeywordAdmin'
        db.delete_table('project_keyword_Admin')

        # Deleting model 'ProjectKeywordEn'
        db.delete_table('project_keyword_en')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 4, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
