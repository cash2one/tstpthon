...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectRecommondReasonAdmin.recommond'
        db.add_column('project_admin_recommond_reason', 'recommond',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectRecommondReasonAdmin.recommond'
        db.delete_column('project_admin_recommond_reason', 'recommond')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.projectrecommondreasonadmin': {
            ...
            'recommond': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
