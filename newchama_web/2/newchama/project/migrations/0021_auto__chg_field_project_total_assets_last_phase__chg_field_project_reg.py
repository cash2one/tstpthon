...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('project_project', 'total_assets_last_phase', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Project.registered_capital'
        db.alter_column('project_project', 'registered_capital', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.income_last_phase'
        db.alter_column('project_project', 'income_last_phase', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Project.growth_three_year'
        db.alter_column('project_project', 'growth_three_year', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.income'
        db.alter_column('project_project', 'income', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Project.profit_last_phase'
        db.alter_column('project_project', 'profit_last_phase', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Project.expected_enterprice_value'
        db.alter_column('project_project', 'expected_enterprice_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Project.profit'
        db.alter_column('project_project', 'profit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Project.total_assets_last_phase'
        db.alter_column('project_project', 'total_assets_last_phase', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Project.registered_capital'
        db.alter_column('project_project', 'registered_capital', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Project.income_last_phase'
        db.alter_column('project_project', 'income_last_phase', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Project.growth_three_year'
        db.alter_column('project_project', 'growth_three_year', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Project.income'
        db.alter_column('project_project', 'income', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Project.profit_last_phase'
        db.alter_column('project_project', 'profit_last_phase', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Project.expected_enterprice_value'
        db.alter_column('project_project', 'expected_enterprice_value', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Project.profit'
        db.alter_column('project_project', 'profit', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 21, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'company_name_cn': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True'}),
            'company_name_en': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True'}),
            ...
            'company_stock_symbol': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'null': 'True'}),
            'company_symbol_cn': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'company_symbol_en': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            ...
            'expected_enterprice_value': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'expire_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'features_cn': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'features_en': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            ...
            'growth_three_year': ('django.db.models.fields.IntegerField', [], {'default': "''", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'income': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'income_last_phase': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            ...
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'price_max': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'price_min': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'profit': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'profit_last_phase': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'pv': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'registered_capital': ('django.db.models.fields.IntegerField', [], {'default': "''", 'null': 'True'}),
            ...
            'total_assets_last_phase': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
        ...
        u'project.projectattach': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_name': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
