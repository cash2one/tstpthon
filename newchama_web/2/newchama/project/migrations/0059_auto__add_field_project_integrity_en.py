...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.integrity_en'
        db.add_column('project_project', 'integrity_en',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.integrity_en'
        db.delete_column('project_project', 'integrity_en')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 11, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
