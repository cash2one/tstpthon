...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectOneclickAttach.add_time'
        db.add_column('project_oneclickAttach', 'add_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 12, 0, 0)),
                      keep_default=False)

        # Adding field 'ProjectOneclickAttach.update_time'
        db.add_column('project_oneclickAttach', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 12, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectOneclickAttach.add_time'
        db.delete_column('project_oneclickAttach', 'add_time')

        # Deleting field 'ProjectOneclickAttach.update_time'
        db.delete_column('project_oneclickAttach', 'update_time')
