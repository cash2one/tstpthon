...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectTargetCompanyDetail.is_delete'
        db.add_column('project_target_company_detail', 'is_delete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectTargetCompanyDetail.update_member'
        db.add_column('project_target_company_detail', 'update_member',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='project_detail_update_member', null=True, to=orm['member.Member']),
                      keep_default=False)

        # Adding field 'ProjectTargetCompanyDetail.update_time'
        db.add_column('project_target_company_detail', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectTargetCompanyDetail.is_delete'
        db.delete_column('project_target_company_detail', 'is_delete')

        # Deleting field 'ProjectTargetCompanyDetail.update_member'
        db.delete_column('project_target_company_detail', 'update_member_id')

        # Deleting field 'ProjectTargetCompanyDetail.update_time'
        db.delete_column('project_target_company_detail', 'update_time')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
