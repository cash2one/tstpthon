...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StockStructure.rate'
        db.alter_column('project_stockstructure', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Project.growth_three_year'
        db.alter_column('project_project', 'growth_three_year', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'StockStructure.rate'
        db.alter_column('project_stockstructure', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Project.growth_three_year'
        db.alter_column('project_project', 'growth_three_year', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Project.stock_percent'
        db.alter_column('project_project', 'stock_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 29, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
