...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DemandViewLog'
        db.delete_table('project_view_log')

        # Adding model 'ProjectViewLog'
        db.create_table('project_view_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_view_log_member', to=orm['member.Member'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_view_log_project', to=orm['project.Project'])),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'project', ['ProjectViewLog'])


    def backwards(self, orm):
        # Adding model 'DemandViewLog'
        db.create_table('project_view_log', (
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_view_log_member', to=orm['member.Member'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_view_log_project', to=orm['project.Project'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'project', ['DemandViewLog'])

        # Deleting model 'ProjectViewLog'
        db.delete_table('project_view_log')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
