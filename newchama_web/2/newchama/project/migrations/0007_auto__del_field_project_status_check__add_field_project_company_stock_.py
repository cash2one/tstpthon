...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.company_stock_exchange'
        db.add_column(u'project_project', 'company_stock_exchange',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.company_stock_exchange'
        db.delete_column(u'project_project', 'company_stock_exchange_id')
