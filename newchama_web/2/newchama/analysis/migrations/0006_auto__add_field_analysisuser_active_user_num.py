...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalysisUser.active_user_num'
        db.add_column(u'analysis_analysisuser', 'active_user_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnalysisUser.active_user_num'
        db.delete_column(u'analysis_analysisuser', 'active_user_num')
