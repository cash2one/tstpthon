...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalysisUser.target_user_num'
        db.add_column(u'analysis_analysisuser', 'target_user_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnalysisUser.target_user_num'
        db.delete_column(u'analysis_analysisuser', 'target_user_num')
    ...
    models = {
        ...
        u'analysis.analysisuser': {
            ...
            'active_user_num': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'target_user_num': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
