...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyDeal.target_company_tags'
        db.add_column(u'monitor_dailydeal', 'target_company_tags',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyDeal.investor_tags'
        db.add_column(u'monitor_dailydeal', 'investor_tags',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DailyDeal.target_company_tags'
        db.delete_column(u'monitor_dailydeal', 'target_company_tags')

        # Deleting field 'DailyDeal.investor_tags'
        db.delete_column(u'monitor_dailydeal', 'investor_tags')
    ...
    models = {
        ...
        u'monitor.dailydeal': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investor_tags': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            'target_company_tags': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
        u'monitor.hknotice': {
