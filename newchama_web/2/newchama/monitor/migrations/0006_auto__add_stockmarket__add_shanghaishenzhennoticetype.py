...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StockMarket'
        db.create_table(u'monitor_stockmarket', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('market_name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('symbol', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'monitor', ['StockMarket'])

        # Adding model 'ShanghaiShenzhenNoticeType'
        db.create_table(u'monitor_shanghaishenzhennoticetype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type_name', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ('symbol', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'monitor', ['ShanghaiShenzhenNoticeType'])


    def backwards(self, orm):
        # Deleting model 'StockMarket'
        db.delete_table(u'monitor_stockmarket')

        # Deleting model 'ShanghaiShenzhenNoticeType'
        db.delete_table(u'monitor_shanghaishenzhennoticetype')
