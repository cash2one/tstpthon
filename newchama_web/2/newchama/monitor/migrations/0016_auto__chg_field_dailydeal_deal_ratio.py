...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyDeal.deal_ratio'
        db.alter_column(u'monitor_dailydeal', 'deal_ratio', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'DailyDeal.deal_ratio'
        db.alter_column(u'monitor_dailydeal', 'deal_ratio', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
