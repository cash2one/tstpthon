...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyDeal.published_date'
        db.add_column(u'monitor_dailydeal', 'published_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DailyDeal.published_date'
        db.delete_column(u'monitor_dailydeal', 'published_date')
