...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HkNotice.market_type'
        db.add_column(u'monitor_hknotice', 'market_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HkNotice.market_type'
        db.delete_column(u'monitor_hknotice', 'market_type')
