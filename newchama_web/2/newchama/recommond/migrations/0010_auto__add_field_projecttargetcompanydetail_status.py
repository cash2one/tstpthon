...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectTargetCompanyDetail.status'
        db.add_column('project_target_company_detail', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectTargetCompanyDetail.status'
        db.delete_column('project_target_company_detail', 'status')
