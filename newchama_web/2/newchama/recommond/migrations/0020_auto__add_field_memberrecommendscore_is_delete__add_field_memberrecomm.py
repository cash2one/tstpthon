...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberRecommendScore.is_delete'
        db.add_column(u'recommond_memberrecommendscore', 'is_delete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MemberRecommendScore.rank'
        db.add_column(u'recommond_memberrecommendscore', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MemberRecommendScore.is_in_control_panel'
        db.add_column(u'recommond_memberrecommendscore', 'is_in_control_panel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberRecommendScore.is_delete'
        db.delete_column(u'recommond_memberrecommendscore', 'is_delete')

        # Deleting field 'MemberRecommendScore.rank'
        db.delete_column(u'recommond_memberrecommendscore', 'rank')

        # Deleting field 'MemberRecommendScore.is_in_control_panel'
        db.delete_column(u'recommond_memberrecommendscore', 'is_in_control_panel')
    ...
    models = {
        ...
        u'recommond.recommonditem': {
            ...
            'is_man': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_star': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'man_add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['project.Project']"}),
