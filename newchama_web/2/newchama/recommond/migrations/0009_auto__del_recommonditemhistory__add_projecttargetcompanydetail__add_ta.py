...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RecommondItemHistory'
        db.delete_table('recommondItem_history')
        ...
        db.create_table('project_target_company_detail', (
            ...
            ('recommondItem', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='project_recommond_item', null=True, to=orm['recommond.RecommondItem'])),
            ...
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 18, 0, 0))),
        ...
        db.send_create_signal(u'recommond', ['ProjectTargetCompanyDetail'])

        # Adding model 'TargetCompanyDetailHistory'
        db.create_table('project_target_company_detail_history', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('target_company_detail', self.gf('django.db.models.fields.related.ForeignKey')(related_name='target_company_detail', to=orm['recommond.ProjectTargetCompanyDetail'])),
            ('operate_status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 18, 0, 0))),
        ))
        db.send_create_signal(u'recommond', ['TargetCompanyDetailHistory'])


    def backwards(self, orm):
        # Adding model 'RecommondItemHistory'
        db.create_table('recommondItem_history', (
            ('operate_status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('recommondItem', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recommend_item', to=orm['recommond.RecommondItem'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 16, 0, 0))),
        ))
        db.send_create_signal(u'recommond', ['RecommondItemHistory'])

        # Deleting model 'ProjectTargetCompanyDetail'
        db.delete_table('project_target_company_detail')

        # Deleting model 'TargetCompanyDetailHistory'
        db.delete_table('project_target_company_detail_history')
    ...
    models = {
        ...
        u'recommond.recommonditem': {
            ...
            'man_add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)'}),
