...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberRecommendScore.is_member_read'
        db.add_column(u'recommond_memberrecommendscore', 'is_member_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberRecommendScore.is_member_read'
        db.delete_column(u'recommond_memberrecommendscore', 'is_member_read')
    ...
    models = {
        ...
        u'recommond.memberrecommendscore': {
            ...
            'is_member_read': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'recommond.recommonditem': {
            ...
            'is_man': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_star': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'man_add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 18, 0, 0)'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['project.Project']"}),
