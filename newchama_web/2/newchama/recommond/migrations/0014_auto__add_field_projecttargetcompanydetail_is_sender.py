...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectTargetCompanyDetail.is_sender'
        db.add_column('project_target_company_detail', 'is_sender',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectTargetCompanyDetail.is_sender'
        db.delete_column('project_target_company_detail', 'is_sender')
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'recommond.recommonditem': {
            ...
            'man_add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 5, 0, 0)'}),
