...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectTargetMemberDetail'
        db.create_table(u'recommond_projecttargetmemberdetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_member_detail', to=orm['project.Project'])),
            ('recommondItem', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='project_member_recommond_item', null=True, to=orm['recommond.MemberRecommendScore'])),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_member_detail_member', to=orm['member.Member'])),
            ...
            ('is_sender', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'recommond', ['ProjectTargetMemberDetail'])


    def backwards(self, orm):
        # Deleting model 'ProjectTargetMemberDetail'
        db.delete_table(u'recommond_projecttargetmemberdetail')
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'recommond.matchingword': {
            'Meta': {'object_name': 'MatchingWord', 'db_table': "'recommond_matching_word'"},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rank': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'word1': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'word2': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'recommond.memberrecommendscore': {
            'Meta': {'object_name': 'MemberRecommendScore'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_delete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_in_control_panel': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_man': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_star': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'matched_tags': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['member.Member']"}),
            'member_score_currency': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'member_score_deal_size': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'member_score_deal_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'member_score_finance_ebitda': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'member_score_finance_growth': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'member_score_finance_net_income': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'member_score_finance_revenue': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'member_score_industry_keyword': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'member_score_local': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'need_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'need_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['project.Project']"}),
            'rank': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'sum_member_score': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'recommond.projectrecommondrefresh': {
            'Meta': {'object_name': 'ProjectRecommondRefresh', 'db_table': "'recommond_project_recommond_refresh'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recommend_refresh_project'", 'to': u"orm['project.Project']"}),
            'recommondItem_id': ('django.db.models.fields.BigIntegerField', [], {'default': '0'})
        },
        u'recommond.projecttargetcompanydetail': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_delete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_sender': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'recommondItem': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'project_recommond_item'", 'null': 'True', 'to': u"orm['recommond.RecommondItem']"}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'recommond.projecttargetmemberdetail': {
            'Meta': {'object_name': 'ProjectTargetMemberDetail'},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_delete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_sender': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'project_member_detail_member'", 'to': u"orm['member.Member']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'project_member_detail'", 'to': u"orm['project.Project']"}),
            'recommend_type': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'recommondItem': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'project_member_recommond_item'", 'null': 'True', 'to': u"orm['recommond.MemberRecommendScore']"}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'recommond.recommonditem': {
            ...
            'is_man': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_star': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'man_add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 18, 0, 0)'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['project.Project']"}),
        ...
        u'recommond.targetcompanydetailhistory': {
            'Meta': {'object_name': 'TargetCompanyDetailHistory', 'db_table': "'project_target_company_detail_history'"},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'operate_status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'target_company_detail': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'target_company_detail'", 'to': u"orm['recommond.ProjectTargetCompanyDetail']"})
        },
