...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecommondProjectItem'
        db.create_table('recommond_project_score', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('demand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demand.Demand'])),
            ...
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 1, 0, 0))),
            ('man_add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 1, 0, 0))),
            ...
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 1, 0, 0), auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'recommond', ['RecommondProjectItem'])


    def backwards(self, orm):
        # Deleting model 'RecommondProjectItem'
        db.delete_table('recommond_project_score')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 1, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'recommond.recommonditem': {
            ...
            'man_add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 1, 0, 0)'}),
