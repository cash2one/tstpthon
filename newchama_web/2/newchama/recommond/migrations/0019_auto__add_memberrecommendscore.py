...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MemberRecommendScore'
        db.create_table(u'recommond_memberrecommendscore', (
            ...
            ('need_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('need_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('sum_member_score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('matched_tags', self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True)),
            ('member_score_industry_keyword', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('member_score_deal_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('member_score_deal_size', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('member_score_currency', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('member_score_local', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('member_score_finance_revenue', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('member_score_finance_growth', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('member_score_finance_net_income', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('member_score_finance_ebitda', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'recommond', ['MemberRecommendScore'])


    def backwards(self, orm):
        # Deleting model 'MemberRecommendScore'
        db.delete_table(u'recommond_memberrecommendscore')
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'recommond.recommonditem': {
            ...
            'is_man': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_star': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'man_add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 11, 0, 0)'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['project.Project']"}),
