...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecommondItem.sum_score'
        db.add_column('recommond_score', 'sum_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecommondItem.sum_score'
        db.delete_column('recommond_score', 'sum_score')
