...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectRecommondRefresh'
        db.create_table('recommond_project_recommond_refresh', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recommend_refresh_project', to=orm['project.Project'])),
            ('recommondItem', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
        ))
        db.send_create_signal(u'recommond', ['ProjectRecommondRefresh'])


    def backwards(self, orm):
        # Deleting model 'ProjectRecommondRefresh'
        db.delete_table('recommond_project_recommond_refresh')
    ...
    models = {
        ...
        u'recommond.projectrecommondrefresh': {
            ...
            'recommondItem': ('django.db.models.fields.BigIntegerField', [], {'default': '0'})
        },
