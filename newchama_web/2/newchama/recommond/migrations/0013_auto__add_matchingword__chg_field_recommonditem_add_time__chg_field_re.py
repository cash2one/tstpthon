...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MatchingWord'
        db.create_table('recommond_matching_word', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('word1', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('word2', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'recommond', ['MatchingWord'])


        # Changing field 'RecommondItem.add_time'
        db.alter_column('recommond_score', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'RecommondProjectItem.add_time'
        db.alter_column('recommond_project_score', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProjectTargetCompanyDetail.add_time'
        db.alter_column('project_target_company_detail', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TargetCompanyDetailHistory.add_time'
        db.alter_column('project_target_company_detail_history', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'MatchingWord'
        db.delete_table('recommond_matching_word')


        # Changing field 'RecommondItem.add_time'
        db.alter_column('recommond_score', 'add_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'RecommondProjectItem.add_time'
        db.alter_column('recommond_project_score', 'add_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ProjectTargetCompanyDetail.add_time'
        db.alter_column('project_target_company_detail', 'add_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TargetCompanyDetailHistory.add_time'
        db.alter_column('project_target_company_detail_history', 'add_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'demand.demand': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'recommond.recommonditem': {
            ...
            'man_add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 11, 0, 0)'}),
