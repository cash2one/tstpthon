...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecommondItem.company_score_has_invest_field'
        db.add_column('recommond_score', 'company_score_has_invest_field',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecommondItem.company_score_has_invest_field'
        db.delete_column('recommond_score', 'company_score_has_invest_field')
    ...
    models = {
        ...
        u'member.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 28, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'recommond.recommonditem': {
            ...
            'man_add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 28, 0, 0)'}),
