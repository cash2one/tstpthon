...
class MemberRecommendScore(models.Model):
    ...
    need_type = models.IntegerField(choices=NEED_TYPES, default=0)
    need_id = models.IntegerField(default=0)
    ...
    sum_member_score = models.IntegerField(default=0)
    matched_tags = models.CharField(max_length=400, blank=True, null=True)
    member_score_industry_keyword = models.IntegerField(default=0)
    member_score_deal_type = models.IntegerField(default=0)
    member_score_deal_size = models.IntegerField(default=0)
    member_score_currency = models.IntegerField(default=0)
    member_score_local = models.IntegerField(default=0)
    member_score_finance_revenue = models.IntegerField(default=0)
    member_score_finance_growth = models.IntegerField(default=0)
    member_score_finance_net_income = models.IntegerField(default=0)
    member_score_finance_ebitda = models.IntegerField(default=0)
    is_member_read = models.BooleanField(default=0)
...
class ProjectTargetMemberDetail(models.Model):
    TYPES = (
        (1, _('Admin')),
        (2, _('Self')),
        (3, _('Submit')),
    )
    project = models.ForeignKey(Project, related_name='project_member_detail')
    recommondItem = models.ForeignKey(MemberRecommendScore, related_name='project_member_recommond_item', blank=True, null=True)
    member = models.ForeignKey(Member, related_name='project_member_detail_member')
    ...
    class Meta:
        db_table = 'recommond_projecttargetmemberdetail'
...
class ProjectRecommondRefresh(models.Model):
    project = models.ForeignKey(Project, related_name='recommend_refresh_project')
    recommondItem_id = models.BigIntegerField(default=0)
    class Meta:
        db_table = 'recommond_project_recommond_refresh'
