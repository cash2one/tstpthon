...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscribe.service_type'
        db.add_column('project_subscribe', 'service_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subscribe.project_stage'
        db.add_column('project_subscribe', 'project_stage',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subscribe.currency_type'
        db.add_column('project_subscribe', 'currency_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscribe.service_type'
        db.delete_column('project_subscribe', 'service_type')

        # Deleting field 'Subscribe.project_stage'
        db.delete_column('project_subscribe', 'project_stage')

        # Deleting field 'Subscribe.currency_type'
        db.delete_column('project_subscribe', 'currency_type')
