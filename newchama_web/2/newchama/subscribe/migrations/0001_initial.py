...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('project_subscribe', (
            ...
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='member_subscribe_publisher', to=orm['member.Member'])),
            ...
            ('deal_size_min', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('deal_size_max', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('total_match', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('tip_interval', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 4, 0, 0), auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'subscribe', ['Subscribe'])
        ...
        # Adding model 'SubscribeKeyword'
        db.create_table('subscribe_keyword', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscribe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscribe_keyword', to=orm['subscribe.Subscribe'])),
            ('keyword', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal(u'subscribe', ['SubscribeKeyword'])


    def backwards(self, orm):
        # Deleting model 'Subscribe'
        db.delete_table('project_subscribe')
        ...
        # Deleting model 'SubscribeKeyword'
        db.delete_table('subscribe_keyword')
    ...
    models = {
        ...
        u'subscribe.subscribe': {
            ...
            'company_industries': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'subscribe_company_industries'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['industry.Industry']"}),
        ...
        u'subscribe.subscribekeyword': {
            'Meta': {'object_name': 'SubscribeKeyword', 'db_table': "'subscribe_keyword'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
