...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscribe.is_push'
        db.add_column('project_subscribe', 'is_push',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscribe.is_push'
        db.delete_column('project_subscribe', 'is_push')
    ...
    models = {
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'subscribe.subscribe': {
            ...
            'last_send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
