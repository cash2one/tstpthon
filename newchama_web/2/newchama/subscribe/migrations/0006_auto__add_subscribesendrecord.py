...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubscribeSendRecord'
        db.create_table('project_subscribe_send_record', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscribe_project', to=orm['project.Project'])),
            ('subscribe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscribe_send', to=orm['subscribe.Subscribe'])),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'subscribe', ['SubscribeSendRecord'])


    def backwards(self, orm):
        # Deleting model 'SubscribeSendRecord'
        db.delete_table('project_subscribe_send_record')
