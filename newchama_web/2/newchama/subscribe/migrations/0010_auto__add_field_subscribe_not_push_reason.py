...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscribe.not_push_reason'
        db.add_column('project_subscribe', 'not_push_reason',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscribe.not_push_reason'
        db.delete_column('project_subscribe', 'not_push_reason')
    ...
    models = {
        ...
        u'subscribe.subscribe': {
            ...
            'is_push': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'last_send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 3, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
