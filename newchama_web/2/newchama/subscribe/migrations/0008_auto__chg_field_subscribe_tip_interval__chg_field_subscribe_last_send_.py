...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscribe.tip_interval'
        db.alter_column('project_subscribe', 'tip_interval', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Subscribe.last_send_time'
        db.alter_column('project_subscribe', 'last_send_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Subscribe.deal_size_max'
        db.alter_column('project_subscribe', 'deal_size_max', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Subscribe.deal_size_min'
        db.alter_column('project_subscribe', 'deal_size_min', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Subscribe.tip_interval'
        db.alter_column('project_subscribe', 'tip_interval', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Subscribe.last_send_time'
        db.alter_column('project_subscribe', 'last_send_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Subscribe.deal_size_max'
        db.alter_column('project_subscribe', 'deal_size_max', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Subscribe.deal_size_min'
        db.alter_column('project_subscribe', 'deal_size_min', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'member.company': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'project.project': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'subscribe.subscribe': {
            ...
            'cv2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cv3': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'deal_size_max': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'deal_size_min': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_delete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'member_subscribe_publisher'", 'to': u"orm['member.Member']"}),
            'name_cn': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'project_stage': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'service_type': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'tip_interval': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
