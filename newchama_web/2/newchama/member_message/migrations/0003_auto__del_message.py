...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # db.delete_table('member_message')
        pass


    def backwards(self, orm):
        # Adding model 'Message'
        db.create_table('member_message', (
            ...
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='member_message_sender', to=orm['member.Member'])),
            ('is_delete', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='member_message_receiver', to=orm['member.Member'])),
        ))
        db.send_create_signal(u'member_message', ['Message'])
