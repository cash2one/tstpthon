...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailTracking.user_agent'
        db.add_column('log_email_tracking', 'user_agent',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailTracking.user_agent'
        db.delete_column('log_email_tracking', 'user_agent')
