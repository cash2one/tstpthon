...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('log_email_tracking', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('buyer_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('seller_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('user_host', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('user_location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('user_device', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('created_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 8, 14, 0, 0), auto_now=True, blank=True)),
            ('lastchanged_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 8, 14, 0, 0), auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'log', ['EmailTracking'])


    def backwards(self, orm):
        # Deleting model 'EmailTracking'
        db.delete_table('log_email_tracking')
    ...
    models = {
        ...
        u'log.adminlog': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'log.emailtracking': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'lastchanged_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
